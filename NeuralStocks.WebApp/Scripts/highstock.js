...
(function() {
    ...
    function L(a, b) { return parseInt(a, b || 10) }

    function Ja(a) { return typeof a === "string" }
    ...
    function Ka(a) { return Object.prototype.toString.call(a) === "[object Array]" }

    function sa(a) { return typeof a === "number" }

    function La(a) { return X.log(a) / X.LN10 }

    function ta(a) { return X.pow(10, a) }
    ...
    function u(a) { return a !== r && a !== null }

    function V(a, b, c) {
        var d, e;
        if (Ja(b))u(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (u(b) && ia(b))for (d in b)a.setAttribute(d, b[d]);
        return e;
    }
    ...
    function M(a, b) {
        if (Ea && !ea && b && b.opacity !== r)b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        w(a.style, b);
    }
    ...
    function ja(a, b) {
        var c = function() { return r };
        c.prototype = new a;
        w(c.prototype, b);
        return c;
    }

    function Ra(a, b) { return Array((b || 2) + 1 - String(a).length).join(0) + a }

    function bb(a) { return(kb && kb(a) || wb || 0) * 6E4 }
    ...
    function xb(a) { return X.pow(10, W(X.log(a) / X.LN10)) }
    ...
    function la(a) { return parseFloat(a.toPrecision(14)) }

    function Ya(a, b) { Ga = p(a, b.animation) }
    ...
    function Ob() {
        ...
        mb = function(a, c, d, h, i, k) {
            var j;
            b ? (j = fa.UTC.apply(0, arguments), j +=
                bb(j)) : j = (new fa(a, c, p(d, 1), p(h, 0), p(i, 0), p(k, 0))).getTime();
            return j;
        };
        Ab = c + "Minutes";
        Bb = c + "Hours";
    ...
    var r,
        ...
        Ub = S.opera,
        Ea = /(msie|trident)/i.test(Ha) && !Ub,
        nb = C.documentMode === 8,
        ob = /AppleWebKit/.test(Ha),
        Va = /Firefox/.test(Ha),
        fb = /(Mobile|Android|Windows Phone)/.test(Ha),
        Ia = "http://www.w3.org/2000/svg",
        ea = !!C.createElementNS && !!C.createElementNS(Ia,
            "svg").createSVGRect,
        Zb = Va && parseInt(Ha.split("Firefox/")[1], 10) < 4,
        ma = !ea && !Ea && !!C.createElement("canvas").getContext,
        Wa,
        $a,
        Vb = {},
        Ib = 0,
    ...
    I = { millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5, month: 24192E5, year: 314496E5 };
                ...
                init: function(b) {
                    ...
                    a.fn.highcharts = function() {
                        ...
                        if (this[0]) {
                            ...
                            c === r && (g = ca[V(this[0], "data-highcharts-chart")]);
                        }
                        return g;
                    };
                },
    ...
    P = {
        ...
        global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/stock/2.1.7/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/stock/2.1.7/gfx/vml-radial-gradient.png" },
    ...
    var ec = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/,
        ...
        wa = function(a) {
            var b = [], c, d;
            (function(a) { a && a.stops ? d = Aa(a.stops, function(a) { return wa(a[1]) }) : (c = ec.exec(a)) ? b = [L(c[1]), L(c[2]), L(c[3]), parseFloat(c[4], 10)] : (c = fc.exec(a)) ? b = [L(c[1], 16), L(c[2], 16), L(c[3], 16), 1] : (c = gc.exec(a)) && (b = [L(c[1]), L(c[2]), L(c[3]), 1]) })(a);
            return{
                get: function(c) {
                    var f;
                    d ? (f = z(a), f.stops = [].concat(f.stops), n(d, function(a, b) { f.stops[b] = [f.stops[b][0], a.get(c)] })) : f = b && !isNaN(b[0]) ? c === "rgb" ? "rgb(" + b[0] + "," + b[1] + "," + b[2] + ")" : c === "a" ? b[3] : "rgba(" + b.join(",") + ")" : a;
                    return f;
                },
                brighten: function(a) {
                    if (d)
    ...
    Y.prototype = {
        ...
        init: function(a, b) {
            this.element = b === "span" ? aa(b) : C.createElementNS(Ia, b);
            this.renderer = a;
        },
        ...
        colorGradient: function(a, b, c) {
            var d = this.renderer, e, f, g, h, i, k, j, m, l, o, q = [];
            ...
            if (f) {
                ...
                f === "radialGradient" && l && !u(g.gradientUnits) && (g = z(g, { cx: l[0] - l[2] / 2 + g.cx * l[2], cy: l[1] - l[2] / 2 + g.cy * l[2], r: g.r * l[2], gradientUnits: "userSpaceOnUse" }));
                for (o in g)
                    o !==
                        "id" && q.push(o, g[o]);
                for (o in k)q.push(k[o]);
                q = q.join(",");
                h[q] ? a = h[q].attr("id") : (g.id = a = "highcharts-" + Ib++, h[q] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], n(k, function(a) {
                    a[1].indexOf("rgba") === 0 ? (e = wa(a[1]), j = e.get("rgb"), m = e.get("a")) : (j = a[1], m = 1);
                    a = d.createElement("stop").attr({ offset: a[0], "stop-color": j, "stop-opacity": m }).add(i);
                    i.stops.push(a);
                }));
            ...
            f ? M(b, e) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), n(a.split(/\s?,\s?/g), function(a) {
                ...
                (f = a[a.length - 2]) && n(c, function(a, c) {
                    ...
                    c === 0 && (a.setAttribute("x", b.getAttribute("x")), c = b.getAttribute("y"), a.setAttribute("y", c || 0), c === null && b.setAttribute("y",
                        0));
                    g = a.cloneNode(1);
                    V(g, { "class": "highcharts-text-shadow", fill: e, stroke: e, "stroke-opacity": 1 / x(L(f), 3), "stroke-width": f, "stroke-linejoin": "round" });
                    b.insertBefore(g, d);
                });
            }));
        },
        ...
        updateShadows: function(a, b) { for (var c = this.shadows, d = c.length; d--;)c[d].setAttribute(a, a === "height" ? x(b - (c[d].cutHeight || 0), 0) : a === "d" ? this.d : b) },
        addClass: function(a) {
        ...
        on: function(a, b) {
            ...
            $a && a === "click" ? (d.ontouchstart = function(a) {
                ...
                a.preventDefault();
                b.call(d, a);
            }, d.onclick = function(a) { (Ha.indexOf("Android") === -1 || fa.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a) }) : d["on" + a] = b;
            return this;
        },
        ...
        getBBox: function(a) {
            ...
            d = this.textStr;
            var i, k = f.style, j, m;
            d !== r && (m = ["", e || 0, g && g.fontSize, f.style.width].join(","), m = d === "" || $b.test(d) ? "num:" + d.toString().length + m : d + m);
            m && !a && (b = c.cache[m]);
            if (!b) {
                if (f.namespaceURI ===
                    Ia || c.forExport) {
                    try {
                        j = this.fakeTS && function(a) { n(f.querySelectorAll(".highcharts-text-shadow"), function(b) { b.style.display = a }) }, Va && k.textShadow ? (i = k.textShadow, k.textShadow = "") : j && j(Z), b = f.getBBox ? w({}, f.getBBox()) : { width: f.offsetWidth, height: f.offsetHeight }, i ? k.textShadow = i : j && j("");
                    } catch (l) {
                    }
                ...
                if (c.isSVG) {
                    ...
                    if (e)
                        b.width = Q(d * ga(h)) + Q(a * ba(h)), b.height =
                            Q(d * ba(h)) + Q(a * ga(h));
                }
                c.cache[m] = b;
            }
        ...
        show: function(a) {
            a && this.element.namespaceURI === Ia ? this.element.removeAttribute("visibility") : this.attr({ visibility: a ? "inherit" : "visible" });
            return this;
        },
        ...
        destroy: function() {
            ...
            a.safeRemoveChild(b);
            for (c && n(c, function(b) { a.safeRemoveChild(b) }); d && d.div && d.div.childNodes.length === 0;)b = d.parentGroup, a.safeRemoveChild(d.div), delete d.div, d = b;
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    V(f, { isShadow: "true", stroke: a.color || "black", "stroke-opacity": k * e, "stroke-width": h, transform: "translate" + j, fill: Z });
        ...
        titleSetter: function(a) {
            ...
            b || (b = C.createElementNS(Ia, "title"), this.element.appendChild(b));
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = V(e, "zIndex"), e !== g && (L(f) > a || !u(a) && u(f)))
                        c.insertBefore(g,
                            e), h = !0;
                h || c.appendChild(g);
            }
    ...
    Y.prototype["stroke-widthSetter"] = Y.prototype.strokeSetter = function(a, b, c) {
        ...
        if (this.stroke && this["stroke-width"])
            this.strokeWidth = this["stroke-width"],
                Y.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
        else if (b === "stroke-width" && a === 0 && this.hasStroke)c.removeAttribute("stroke"), this.hasStroke = !1;
    };
    var na = function() { this.init.apply(this, arguments) };
    na.prototype = {
        Element: Y,
        init: function(a, b, c, d, e) {
            ...
            this.createElement("desc").add().element.appendChild(C.createTextNode("Created with Highstock 2.1.7"));
            ...
            this.setSize(b, c, !1);
            var h;
            if (Va && a.getBoundingClientRect)
                this.subPixelFix = b = function() {
                    M(a, { left: 0, top: 0 });
                    h = a.getBoundingClientRect();
                    M(a, { left: za(h.left) - h.left + "px", top: za(h.top) - h.top + "px" });
                }, b(), D(S, "resize", b);
        },
        getStyle: function(a) { return this.style = w({ fontFamily: "\"Lucida Grande\", \"Lucida Sans Unicode\", Arial, Helvetica, sans-serif", fontSize: "12px" }, a) },
        ...
        buildText: function(a) {
            for (var b = a.element,
                ...
                s = g.length,
                E = m && !a.added && this.box,
                $ = function(a) {
                    return l ? L(l) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : j && j.fontSize || c.style.fontSize || 12,
                        a).h;
                },
                t = function(a) { return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">") }; s--;)b.removeChild(g[s]);
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, E && E.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, "<span style=\"font-weight:bold\">").replace(/<(i|em)>/g, "<span style=\"font-style:italic\">").replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), n(e, function(e, f) {
                var g,
                    l = 0,
                ...
                n(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        var o = {}, s = C.createElementNS(Ia, "tspan"), E;
                        h.test(e) && (E = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), V(s, "style", E));
                        i.test(e) && !d && (V(s, "onclick", "location.href=\"" + e.match(i)[1] + "\""), M(s, { cursor: "pointer" }));
                        e = t(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            b.appendChild(s);
                            !l && f &&
                            (!ea && d && M(s, { display: "block" }), V(s, "dy", $(s)));
                            if (m) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || o.length > 1 && j.whiteSpace !== "nowrap", n, y, r, u = [], v = $(s), x = 1, w = a.rotation, z = e, B = z.length; (p || q) && (o.length || u.length);)
                                    a.rotation = 0, n = a.getBBox(!0), r = n.width, !ea && c.forExport && (r = c.measureSpanWidth(s.firstChild.data, a.styles)), n = r > m, y === void 0 && (y = n), q && y ? (B /= 2, z === "" || !n && B < 0.5 ? o = [] : (n && (y = !0), z = e.substring(0, z.length + (n ? -1 : 1) * za(B)), o = [z + (m > 3 ? "…" : "")], s.removeChild(s.firstChild))) :
                                        !n || o.length === 1 ? (o = u, u = [], o.length && (x++, s = C.createElementNS(Ia, "tspan"), V(s, { dy: v, x: k }), E && V(s, "style", E), b.appendChild(s)), r > m && (m = r)) : (s.removeChild(s.firstChild), u.unshift(o.pop())), o.length && s.appendChild(C.createTextNode(o.join(" ").replace(/- /g, "-")));
            ...
            }), E && E.removeChild(b), o && a.applyTextShadow && a.applyTextShadow(o));
        },
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            var k =
                ...
                e = z({ "stroke-width": 1, stroke: "#CCCCCC", fill: { linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]] }, r: 2, padding: 5, style: { color: "black" } }, e);
            o = e.style;
            delete e.style;
            ...
            E = h.style;
            delete h.style;
            D(k.element, Ea ? "mouseover" : "mouseenter", function() { j !== 3 && k.attr(f).css(q) });
            D(k.element, Ea ? "mouseout" : "mouseleave", function() { j !== 3 && (m = [e, f, g][j], l = [o, q, s][j], k.attr(m).css(l)) });
            k.setState = function(a) { (k.state = j = a) ? a === 2 ? k.attr(g).css(s) : a === 3 && k.attr(h).css(E) : k.attr(e).css(o) };
            return k.on("click", function() { j !== 3 && d.call(k) }).attr(e).css(w({ cursor: "default" }, o));
        },
        ...
        rect: function(a, b, c, d, e, f) {
            var e = ia(a) ? a.r :
                ...
                a = ia(a) ? a : a === r ? {} : { x: a, y: b, width: x(c, 0), height: x(d, 0) };
            if (f !== r)a.strokeWidth = f, a = g.crisp(a);
            if (e)a.r = e;
            g.rSetter = function(a) { V(this.element, { rx: a, ry: a }) };
            return g.attr(a);
        },
        ...
        symbol: function(a, b, c, d, e, f) {
            var g, h = this.symbols[a], h = h && h(v(b), v(c), d, e, f), i = /^url\((.*?)\)$/, k, j;
            if (h)g = this.path(h), w(g, { symbolName: a, x: b, y: c, width: d, height: e }), f && w(g, f);
            else if (i.test(a))
                j = function(a, b) {
                    a.element && (a.attr({ width: b[0], height: b[1] }),
                        a.alignByTranslate || a.translate(v((d - b[0]) / 2), v((e - b[1]) / 2)));
                }, k = a.match(i)[1], a = Vb[k] || f && f.width && f.height && [f.width, f.height], g = this.image(k).attr({ x: b, y: c }), g.isImg = !0, a ? j(g, a) : (g.attr({ width: 0, height: 0 }), aa("img", { onload: function() { j(g, Vb[k] = [this.width, this.height]) }, src: k }));
            return g;
        },
        symbols: {
            ...
            triangle: function(a,
                b, c, d) { return["M", a + c / 2, b, "L", a + c, b + d, a, b + d, "Z"] },
            ...
            arc: function(a, b, c, d, e) {
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = ba(f), k = ga(f), j = ba(g), g = ga(g), e = e.end - f < va ? 0 : 1;
        ...
        text: function(a, b, c, d) {
            ...
            if (!d)
                a.xSetter = function(a, b, c) {
                    ...
                    for (l =
                        0; l < d.length; l++)e = d[l], e.getAttribute(b) === f && e.setAttribute(b, a);
                    c.setAttribute(b, a);
                };
            return a;
        },
        fontMetrics: function(a, b) {
            ...
            a = /px/.test(a) ? L(a) : /em/.test(a) ? parseFloat(a) * 12 : 12;
            c = a < 24 ? a + 3 : v(a * 1.2);
            d = v(c * 0.8);
            return{ h: c, b: d, f: a };
        },
        rotCorr: function(a, b, c) {
            var d = a;
            b && c && (d = x(d * ba(b * ra), 4));
            return{ x: -a / 3 * ga(b * ra), y: d };
        },
        label: function(a, b, c, d, e, f, g, h, i) {
            function k() {
                var a, b;
                a = q.element.style;
                E = (oa === void 0 || x === void 0 || o.styles.textAlign) && u(q.textStr) && q.getBBox();
                o.width = (oa || E.width || 0) + 2 * t + y;
                o.height = (x || E.height || 0) + 2 * t;
                A = t + l.fontMetrics(a && a.fontSize, q).b;
                if (D) {
                    if (!s)a = v(-p * t) + sb, b = (h ? -A : 0) + sb, o.box = s = d ? l.symbol(d, a, b, o.width, o.height, K) : l.rect(a, b, o.width, o.height, 0, K[ac]), s.attr("fill", Z).add(o);
                    s.isImg || s.attr(w({ width: v(o.width), height: v(o.height) }, K));
                    K = null;
                }
            }
            ...
            function m(a, b) { s ? s.attr(a, b) : K[a] = b }

            var l = this, o = l.g(i), q = l.text("", 0, 0, g).attr({ zIndex: 1 }), s, E, p = 0, t = 3, y = 0, oa, x, B, Kb, sb = 0, K = {}, A, D;
            o.onAdd = function() {
                q.add(o);
                o.attr({ text: a || a === 0 ? a : "", x: b, y: c });
                s && u(e) && o.attr({ anchorX: e, anchorY: f });
            };
            o.widthSetter = function(a) { oa = a };
            o.heightSetter = function(a) { x = a };
            o.paddingSetter = function(a) { if (u(a) && a !== t)t = o.padding = a, j() };
            o.paddingLeftSetter = function(a) {
                u(a) && a !== y &&
                (y = a, j());
            };
            o.alignSetter = function(a) { p = { left: 0, center: 0.5, right: 1 }[a] };
            ...
            return w(o, {
                css: function(a) {
                    if (a) {
                        var b = {}, a = z(a);
                        n(o.textProps, function(c) { a[c] !== r && (b[c] = a[c], delete a[c]) });
                        q.css(b);
                    }
                    return C.call(o, a);
                },
                getBBox: function() { return{ width: E.width + 2 * t, height: E.height + 2 * t, x: E.x - t, y: E.y - t } },
                shadow: function(a) {
                    s && s.shadow(a);
                    return o;
                },
    ...
    w(Y.prototype, {
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                i && n(i, function(a) { M(a, { marginLeft: c + 1, marginTop: d + 1 }) });
                this.inverted && n(b.childNodes, function(c) { a.invertChild(c, b) });
                if (b.tagName === "SPAN") {
                    var j = this.rotation, m, l = L(this.textWidth), o = [j, g, b.innerHTML, this.textWidth].join(",");
                    if (o !== this.cTT) {
        ...
        setSpanRotation: function(a, b, c) {
            var d = {}, e = Ea ? "-ms-transform" : ob ? "-webkit-transform" : Va ? "MozTransform" : Ub ? "-o-transform" : "";
            d[e] = d.transform = "rotate(" + a + "deg)";
            d[e + (Va ? "Origin" : "-origin")] = d.transformOrigin = b * 100 + "% " + c +
                "px";
            M(this.element, d);
        },
    ...
    w(na.prototype, {
        html: function(a, b, c) {
            ...
            d.attr({ text: a, x: v(b), y: v(c) }).css({ position: "absolute", fontFamily: this.style.fontFamily, fontSize: this.style.fontSize });
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            n(k.reverse(), function(a) {
                                var d, e = V(a.element, "class");
                                e && (e = { className: e });
                                b = a.div = a.div || aa(Ua, e, { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px" }, b || c);
                                d = b.style;
                                w(a, {
    ...
    if (!ea && !ma)
        H = {
                ...
                setSpanRotation: function() {
                    var a = this.rotation, b = ba(a * ra), c = ga(a * ra);
                    M(this.element, {
                ...
                getSpanCorrection: function(a, b, c, d, e) {
                    var f = d ? ba(d * ra) : 1, g = d ? ga(d * ra) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
                    this.xCorr = f < 0 && -a;
                    this.yCorr = g < 0 && -h;
                    i = f * g < 0;
                ...
                clip: function(a) {
                    var b = this, c;
                    a ? (c = a.members, ua(c, b), c.push(b), b.destroyClip = function() { ua(c, b) }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = { clip: nb ? "inherit" : "rect(auto)" });
                    return b.css(a);
                },
                ...
                shadow: function(a, b, c) {
                    ...
                    if (a) {
                        ...
                        for (e = 1; e <= 3; e++) {
                            ...
                            k = [
                                "<shape isShadow=\"true\" strokeweight=\"", m, "\" filled=\"false\" path=\"",
                                l, "\" coordsize=\"10 10\" style=\"", f.style.cssText, "\" />"
                            ];
                            h = aa(g.prepVML(k), null, { left: L(i.left) + p(a.offsetX, 1), top: L(i.top) + p(a.offsetY, 1) });
                            if (c)h.cutOff = m + 1;
                ...
                visibilitySetter: function(a, b, c) {
                    a === "inherit" && (a = "visible");
                    this.shadows && n(this.shadows, function(c) { c.style[b] = a });
            ...
            }, A.VMLElement = H = ja(Y, H), H.prototype.ySetter = H.prototype.widthSetter = H.prototype.heightSetter = H.prototype.xSetter, H = {
                Element: H,
                isIE8: Ha.indexOf("MSIE 8.0") > -1,
                init: function(a, b, c, d) {
                    var e;
                    this.alignedObjects = [];
                    d = this.createElement(Ua).css(w(this.getStyle(d),
                    { position: "relative" }));
                    e = d.element;
                ...
                color: function(a, b, c, d) {
                    ...
                    if (i) {
                        var j, m, l = a.linearGradient || a.radialGradient, o, q, s, E, p, t = "", a = a.stops, y, oa = [],
                            r = function() {
                                h = ["<fill colors=\"" + oa.join(",") + "\" opacity=\"", s, "\" o:opacity2=\"", q, "\" type=\"", i, "\" ", t, "focus=\"100%\" method=\"any\" />"];
                        ...
                        y[0] < 1 && a.push([1, y[1]]);
                        n(a, function(a, b) {
                            g.test(a[1]) ? (f = wa(a[1]), j = f.get("rgb"), m = f.get("a")) : (j = a[1], m = 1);
                            oa.push(a[0] * 100 + "% " + j);
                            b ? (s = m, E = j) : (q = m, p = j);
                        });
                        if (c === "fill")
                            if (i === "gradient")c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, t = "angle=\"" + (90 - X.atan((l - a) / (o - c)) * 180 / va) + "\"", r();
                            else {
                                var k = l.r,
                                    u = k * 2,
                                    x = k * 2,
                                    ...
                                    B,
                                    k = function() {
                                        z && (B = d.getBBox(), v += (z[0] - B.x) / B.width - 0.5, w += (z[1] - B.y) / B.height - 0.5, u *= z[2] / B.width, x *= z[2] / B.height);
                                        t = "src=\"" + P.global.VMLRadialGradientURL +
                                            "\" size=\"" + u + "," + x + "\" origin=\"0.5,0.5\" position=\"" + v + "," + w + "\" color2=\"" + p + "\" ";
                                        r();
                                    };
                                d.added ? k() : d.onAdd = k;
                                k = E;
                    ...
                    } else if (g.test(a) && b.tagName !== "IMG")f = wa(a), h = ["<", c, " opacity=\"", f.get("a"), "\"/>"], aa(this.prepVML(h), null, null, b), k = f.get("rgb");
                    else {
                ...
                createElement: function(a) { return a === "rect" ? this.symbol(a) : na.prototype.createElement.call(this, a) },
                invertChild: function(a, b) {
                    var c = this, d = b.style, e = a.tagName === "IMG" && a.style;
                    M(a, { flip: "x", left: L(d.width) - (e ? L(e.top) : 1), top: L(d.height) - (e ? L(e.left) : 1), rotation: -90 });
                ...
                symbols: {
                    ...
                    rect: function(a, b, c, d, e) { return na.prototype.symbols[!u(e) || !e.r ? "square" : "callout"].call(0, a, b, c, d, e) }
                }
            },
            A.VMLRenderer = ib = function() { this.init.apply(this, arguments) }, ib.prototype = z(na.prototype, H), Wa = ib;
    ...
    var Wb;
    if (ma)
        A.CanVGRenderer = H = function() { Ia = "http://www.w3.org/1999/xhtml" }, H.prototype.symbols = {}, Wb = function() {
            function a() {
                var a = b.length, d;
                for (d = 0; d < a; d++)b[d]();
                b = [];
    ...
    Za.prototype = {
        addLabel: function() {
            ...
            this.isFirst = i;
            this.isLast = k;
            b = a.labelFormatter.call({ axis: a, chart: c, isFirst: i, isLast: k, dateTimeLabelFormat: j, value: a.isLog ? la(ta(e)) : e });
            u(d) ? d && d.attr({ text: b }) : (this.labelLength = (this.label =
                d = u(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(z(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0);
        },
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                e = p(b.labelRight, x(b.pos + b.len, d - e[1])),
                g = this.label,
                h = this.rotation,
                ...
                o =
                {};
            if (h)h < 0 && c - i * k < f ? l = v(c / ba(h * ra) - f) : h > 0 && c + i * k > e && (l = v((d - c) / ba(h * ra)));
            else if (d = c + (1 - i) * k, c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i, m = -1), j = B(b.slotWidth, j), j < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - j - i * (b.slotWidth - B(k, j)))), k > j || b.autoRotation && g.styles.width)l = j;
            if (l) {
                o.width = l;
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            var i = this.axis, k = i.transA, j = i.reversed, m = i.staggerLines, l = i.tickRotCorr || { x: 0, y: 0 }, c = p(e.y, l.y + (i.side === 2 ? 8 : -(c.getBBox().height / 2))), a = a + e.x + l.x - (f && d ? f * k * (j ? -1 : 1) : 0), b = b + c - (f && !d ? f * k * (j ? 1 : -1) : 0);
        ...
        render: function(a, b, c) {
            var d = this.axis,
                ...
                u = !0,
                x = d.tickmarkOffset,
                v = this.getPosition(g, k, x, b),
                w = v.x,
                v = v.y,
                z = g && w === d.pos + d.len || !g && v === d.pos ?
                    -1 : 1,
                c = p(c, 1);
            this.isActive = !0;
            if (q) {
                k = d.getPlotLinePath(k + x, q * z, b, !0);
                if (m === r) {
                    m = { stroke: s, "stroke-width": q };
                    if (E)m.dashstyle = E;
                    if (!h)m.zIndex = 1;
                    if (b)m.opacity = 0;
            ...
            if (l && n)y === "inside" && (n = -n), d.opposite && (n = -n), h = this.getMarkPath(w, v, n, l * z, g, f), o ? o.animate({ d: h, opacity: c }) : this.mark = f.path(h).attr({ stroke: t, "stroke-width": l, opacity: c }).add(d.axisGroup);
            if (i && !isNaN(w))
                i.xy = v = this.getLabelPosition(w,
                    v, i, g, j, x, a, oa), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? u = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(v), oa && a % oa && (u = !1), u && !isNaN(v.y) ? (v.opacity = c, i[this.isNew ? "attr" : "animate"](v), this.isNew = !1) : i.attr("y", -9999);
        },
    ...
    A.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (g) {
                if (o = b.getPlotLinePath(j, g), t = { stroke: s, "stroke-width": g }, m)t.dashstyle = m;
            } else if (k) {
            ...
            if (u(E))t.zIndex = E;
            if (l)
                if (o)l.animate({ d: o }, null, l.onGetPath);
                else {
                    if (l.hide(),
                        l.onGetPath = function() { l.show() }, f)a.label = f = f.destroy();
                }
            else if (o && o.length && (a.svgElem = l = p.path(o).attr(t).add(), n))for (q in d = function(b) { l.on(b, function(c) { n[b].apply(a, [c]) }) }, n)d(q);
            if (e && u(e.text) && o && o.length && b.width > 0 && b.height > 0) {
                e = z({ align: c && k && "center", x: c ? !k && 4 : 10, verticalAlign: !c && k && "middle", y: c ? k ? 16 : 10 : k ? 6 : -4, rotation: c && !k && 90 }, e);
                if (!f) {
                ...
                o = Sa(b);
                c = Sa(k);
                f.align(e, !1, { x: o, y: c, width: Fa(b) - o, height: Fa(k) - c });
                f.show();
            } else f && f.hide();
            return a;
        },
    ...
    var J = A.Axis = function() { this.init.apply(this, arguments) };
    J.prototype = {
        defaultOptions: {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: { enabled: !1, formatter: function() { return A.numberFormat(this.total, -1) }, style: z(U.line.dataLabels.style, { color: "#000000" }) }
        },
        ...
        init: function(a, b) {
            ...
            this.crosshair = p(d.crosshair, pa(a.options.tooltip.crosshairs)[c ?
                0 : 1], !1);
        ...
        setOptions: function(a) {
            this.options = z(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [
                this.defaultTopAxisOptions,
                this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions
            ][this.side], z(P[this.coll], a));
        },
        defaultLabelFormatter: function() {
            ...
            else if (f && a >= 1E3)for (; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = A.numberFormat(b / c, -1) + e[f]);
            g === r && (g = Q(b) >=
                1E4 ? A.numberFormat(b, -1) : A.numberFormat(b, -1, r, ""));
            return g;
        },
        getSeriesExtremes: function() {
            ...
            n(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && d <= 0 && (d = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length)a.dataMin = B(p(a.dataMin, d[0]), Sa(d)), a.dataMax = x(p(a.dataMax, d[0]), Fa(d));
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (u(c) && u(e))a.dataMin = B(p(a.dataMin, c), c), a.dataMax = x(p(a.dataMax, e), e);
                        if (u(d))
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            b ? (a = a * h + i, a -= j, a = a / k + d, e && (a =
                g.lin2val(a))) : (e && (a = g.val2lin(a)), f === "between" && (f = 0.5), a = h * (a - d) * k + i + h * j + (sa(f) ? k * f * g.pointRange : 0));
            return a;
        },
        ...
        getLinearTickPositions: function(a, b, c) {
            var d, e = la(W(b / a) * a), f = la(za(c / a) * a), g = [];
        ...
        setAxisTranslation: function(a) {
            ...
            if (j || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : n(b.series, function(a) {
                    var h = i ? 1 : j ? a.pointRange : b.axisPointRange || 0, k = a.options.pointPlacement, q = a.closestPointRange;
                    h > c && (h = 0);
                    d = x(d, h);
                    b.single || (f = x(f, Ja(k) ? 0 : h / 2), g = x(g, k === "on" ? 0 : h));
                    !a.noSharedTooltip && u(q) && (e = u(e) ? B(e, q) : q);
                }), h = b.ordinalSlope && e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = B(d,
                    c), j)b.closestPointRange = e;
            if (a)b.oldTransA = k;
        ...
        setTickInterval: function(a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, k = d.minPadding, j = d.tickInterval, m = d.tickPixelInterval, l = b.categories;
            ...
            h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !==
                b.linkedParent.options.type && qa(11, 1)) : (b.min = p(b.userMin, d.min, b.dataMin), b.max = p(b.userMax, d.max, b.dataMax));
            if (e)!a && B(b.min, p(b.dataMin, b.min)) <= 0 && qa(10, 1), b.min = la(La(b.min)), b.max = la(La(b.max));
            if (b.range && u(b.max))b.userMin = b.min = x(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
            ...
            if (!l && !b.axisPointRange && !b.usePercentage && !h && u(b.min) && u(b.max) && (c = b.max - b.min)) {
                if (!u(d.min) && !u(b.userMin) && k && (b.dataMin < 0 || !b.ignoreMinPadding))
                    b.min -=
                        c * k;
                if (!u(d.max) && !u(b.userMax) && i && (b.dataMax > 0 || !b.ignoreMaxPadding))b.max += c * i;
            }
            if (sa(d.floor))b.min = x(b.min, d.floor);
            if (sa(d.ceiling))b.max = B(b.max, d.ceiling);
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !j && m === b.linkedParent.options.tickPixelInterval ? j = b.linkedParent.tickInterval : p(j, this.tickAmount ? (b.max - b.min) / x(this.tickAmount - 1, 1) : void 0, l ? 1 : (b.max - b.min) * m / x(b.len, m));
            g && !a && n(b.series, function(a) { a.processData(b.min !== b.oldMin || b.max !== b.oldMax) });
            b.setAxisTranslation(!0);
            b.beforeSetTickPositions && b.beforeSetTickPositions();
            if (b.postProcessTickInterval)b.tickInterval = b.postProcessTickInterval(b.tickInterval);
            if (b.pointRange)b.tickInterval = x(b.pointRange, b.tickInterval);
            a = p(d.minTickInterval, b.isDatetimeAxis && b.closestPointRange);
            if (!j && b.tickInterval < a)b.tickInterval = a;
            if (!f && !e && !j)b.tickInterval = yb(b.tickInterval, null, xb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function() {
            ...
            if (!b && (this.tickPositions = b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval,
                a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), d && (d = d.apply(this, [this.min, this.max]))))this.tickPositions = b = d;
        ...
        setExtremes: function(a, b, c, d, e) {
            ...
            n(f.series, function(a) { delete a.kdTree });
            e = w(e, { min: a, max: b });
        ...
        zoom: function(a, b) {
            var c = this.dataMin,
                d = this.dataMax,
                e = this.options;
            this.allowZoomOutside || (u(c) && a <= B(c, p(e.min, c)) && (a = r), u(d) && b >= x(d, p(e.max, d)) && (b = r));
        ...
        getExtremes: function() {
            var a = this.isLog;
            return{ min: a ? la(ta(this.min)) : this.min, max: a ? la(ta(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
        },
        getThreshold: function(a) {
            var b = this.isLog, c = b ? ta(this.min) : this.min, b = b ? ta(this.max) : this.max;
            a === null ? a = b < 0 ? b : c : c > a ? a = c : b < a && (a = b);
            return this.translate(a, 0, 1,
                0, 1);
        },
        ...
        unsquish: function() {
            var a = this.ticks, b = this.options.labels, c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g, h = b.rotation, i = this.chart.renderer.fontMetrics(b.style.fontSize, a[0] && a[0].label), k, j = Number.MAX_VALUE, m,
                l = function(a) {
                    a /= f || 1;
                    a = a > 1 ? za(a) : 1;
                    return a * d;
                };
            c ? (m = u(h) ? [h] : f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) &&
                n(m, function(a) {
                    var b;
                    if (a === h || a && a >= -90 && a <= 90)k = l(Q(i.h / ga(ra * a))), b = k + Q(a / 360), b < j && (j = b, g = a, e = k);
                }) : e = l(i.h);
            this.autoRotation = m;
        ...
        renderUnsquish: function() {
            ...
            if (this.autoRotation)n(c, function(a) { if ((a = d[a]) && a.labelLength > l)l = a.labelLength }), l > k && l > g.h ? j.rotation = this.labelRotation : this.labelRotation = 0;
            else if (i && (m = { width: k + "px" }, !h)) {
                m.textOverflow = "clip";
            ...
            if (j.rotation &&
            (m = { width: (l > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + "px" }, !h))m.textOverflow = "ellipsis";
            this.labelAlign = j.align = e.align || this.autoLabelAlign(this.labelRotation);
            n(c, function(a) {
                var b = (a = d[a]) && a.label;
                if (b)m && b.css(z(m, b.specCss)), delete b.specCss, b.attr(j), a.rotation = j.rotation;
            });
            this.tickRotCorr = b.rotCorr(g.b, this.labelRotation || 0, this.side === 2);
        },
        hasData: function() { return this.hasVisibleSeries || u(this.min) && u(this.max) && !!this.tickPositions },
        getOffset: function() {
            var a = this,
                b = a.chart,
                c = b.renderer,
            ...
            if (!a.axisGroup)
                a.gridGroup = c.g("grid").attr({ zIndex: d.gridZIndex || 1 }).add(), a.axisGroup = c.g("axis").attr({ zIndex: d.zIndex || 2 }).add(), a.labelGroup = c.g("axis-labels").attr({ zIndex: s.zIndex || 7 }).addClass("highcharts-" + a.coll.toLowerCase() +
                    "-labels").add();
            if (k || a.isLinked) {
                if (n(e, function(b) { f[b] ? f[b].addLabel() : f[b] = new Za(a, b) }), a.renderUnsquish(), n(e, function(b) { if (h === 0 || h === 2 || { 1: "left", 3: "right" }[h] === a.labelAlign)E = x(f[b].getLabelSize(), E) }), a.staggerLines)E *= a.staggerLines, a.labelOffset = E;
            } else for (y in f)f[y].destroy(), delete f[y];
            if (q && q.text && q.enabled !== !1) {
                if (!a.axisTitle)
                    a.axisTitle = c.text(q.text, 0, 0, q.useHTML).attr({ zIndex: 7, rotation: q.rotation || 0, align: q.textAlign || { low: "left", middle: "center", high: "right" }[q.align] }).addClass("highcharts-" +
                        this.coll.toLowerCase() + "-title").css(q.style).add(a.axisGroup), a.axisTitle.isNew = !0;
                if (j)m = a.axisTitle.getBBox()[g ? "height" : "width"], l = q.offset, o = u(l) ? 0 : p(q.margin, g ? 5 : 10);
                a.axisTitle[j ? "show" : "hide"]();
            }
            a.offset = t * p(d.offset, $[h]);
            a.tickRotCorr = a.tickRotCorr || { x: 0, y: 0 };
            c = h === 2 ? a.tickRotCorr.y : 0;
            g = E + o + (E && t * (g ? p(s.y, a.tickRotCorr.y + 8) : s.x) - c);
            a.axisTitleMargin = p(l, g);
            $[h] = x($[h], a.axisTitleMargin + m + t * a.offset, g);
            m = W(d.lineWidth / 2) * 2;
            d.offset && (m = x(0, m - d.offset));
            b[i] = x(b[i], m);
        },
        ...
        render: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, k = a.minorTicks, j = a.alternateBands, m = d.stackLabels, l = d.alternateGridColor, o = a.tickmarkOffset, q = d.lineWidth, s, E = b.hasRendered && u(a.oldMin) && !isNaN(a.oldMin), p = a.showAxis, t, y;
            ...
            if (a.hasData() || f) {
                a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
                    ...
                    E && k[b].isNew && k[b].render(null, !0);
                    k[b].render(null, !1, 1);
                });
                if (g.length && (n(g, function(b, c) { if (!f || b >= a.min && b <= a.max)i[b] || (i[b] = new Za(a, b)), E && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c) }), o && (a.min === 0 || a.single)))i[-1] || (i[-1] = new Za(a, -1, null, !0)), i[-1].render(-1);
                l && n(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max)
                        j[b] || (j[b] = new A.PlotLineOrBand(a)), t = b + o, y = g[c + 1] !==
                            r ? g[c + 1] + o : a.max, j[b].options = { from: e ? ta(t) : t, to: e ? ta(y) : y, color: l }, j[b].render(), j[b].isActive = !0;
                });
                if (!a._addedPlotLB)n((d.plotLines || []).concat(d.plotBands || []), function(b) { a.addPlotBandOrLine(b) }), a._addedPlotLB = !0;
            }
            n([i, k, j], function(a) {
                var c, d, e = [], f = Ga ? Ga.duration || 500 : 0, g = function() { for (d = e.length; d--;)a[e[d]] && !a[e[d]].isActive && (a[e[d]].destroy(), delete a[e[d]]) };
                for (c in a)if (!a[c].isActive)a[c].render(c, !1, 0), a[c].isActive = !1, e.push(c);
                a === j || !b.hasRendered || !f ? g() : f && setTimeout(g, f);
            });
            if (q)s = a.getLinePath(q), a.axisLine ? a.axisLine.animate({ d: s }) : a.axisLine = c.path(s).attr({ stroke: d.lineColor, "stroke-width": q, zIndex: 7 }).add(a.axisGroup), a.axisLine[p ? "show" : "hide"]();
        ...
        destroy: function(a) {
            ...
            for (d in c)
                Na(c[d]),
                    c[d] = null;
            n([b.ticks, b.minorTicks, b.alternateBands], function(a) { Na(a) });
            for (a = e.length; a--;)e[a].destroy();
            n("stackTotalGroup,axisLine,axisTitle,axisGroup,cross,gridGroup,labelGroup".split(","), function(a) { b[a] && (b[a] = b[a].destroy()) });
            this.cross && this.cross.destroy();
        },
        drawCrosshair: function(a, b) {
            var c, d = this.crosshair, e = d.animation;
            if (!this.crosshair || (u(b) || !p(this.crosshair.snap, !0)) === !1 || b && b.series && b.series[this.coll] !== this)this.hideCrosshair();
            else if (p(d.snap, !0) ? u(b) && (c = this.isXAxis ? b.plotX :
                this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)this.hideCrosshair();
    ...
    w(J.prototype, {
        ...
        addPlotBandOrLine: function(a, b) {
            var c =
                (new A.PlotLineOrBand(this, a)).render(),
                d = this.userOptions;
        ...
        removePlotBandOrLine: function(a) {
            ...
            n([c.plotLines || [], d.plotLines || [], c.plotBands || [], d.plotBands || []], function(b) { for (e = b.length; e--;)b[e].id === a && ua(b, b[e]) });
        }
    });
    J.prototype.getTimeTicks = function(a, b, c, d) {
        var e = [],
            ...
            j = a.count;
        if (u(b)) {
            i[Pb](k >= I.second ? 0 : j * W(i.getMilliseconds() / j));
            if (k >= I.second)i[Qb](k >= I.minute ? 0 : j * W(i.getSeconds() / j));
            if (k >= I.minute)i[Rb](k >= I.hour ? 0 : j * W(i[Ab]() / j));
            if (k >= I.hour)i[Sb](k >= I.day ? 0 : j * W(i[Bb]() / j));
            if (k >= I.day)i[Db](k >= I.month ? 1 : j * W(i[cb]() / j));
            k >= I.month && (i[Eb](k >= I.year ? 0 : j * W(i[db]() / j)), h = i[eb]());
            k >= I.year && (h -= h % j, i[Fb](h));
            if (k === I.week)i[Db](i[cb]() - i[Cb]() + p(d, 1));
            b = 1;
            if (wb || kb)i = i.getTime(), i = new fa(i + bb(i));
            h = i[eb]();
            for (var d = i.getTime(),
                m = i[db](),
                l =
                    i[cb](),
                o = (I.day + (g ? bb(i) : i.getTimezoneOffset() * 6E4)) % I.day; d < c;)e.push(d), k === I.year ? d = mb(h + b * j, 0) : k === I.month ? d = mb(h, m + b * j) : !g && (k === I.day || k === I.week) ? d = mb(h, m, l + b * j * (k === I.day ? 1 : 7)) : d += k * j, b++;
            e.push(d);
            n(hb(e, function(a) { return k <= I.hour && a % I.day === o }), function(a) { f[a] = "day" });
        }
    ...
    J.prototype.normalizeTimeTickInterval = function(a, b) {
        var c = b || [
                ["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]],
    ...
    J.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5)
            ...
            for (var f = W(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                i = e.length;
                for (h = 0; h < i && !m; h++)k = La(ta(f) * e[h]), k > b && (!d || j <= c) && j !== r && g.push(j), j > c && (m = !0), j = k;
            }
        else if (b = ta(b), c = ta(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = yb(a, null, xb(a)), g = Aa(this.getLinearTickPositions(a, b, c), La), !d)this._minorAutoInterval = a / 5;
        if (!d)
            this.tickInterval =
                a;
        return g;
    };
    var Lb = A.Tooltip = function() { this.init.apply(this, arguments) };
    Lb.prototype = {
        init: function(a, b) {
        ...
        move: function(a, b, c, d) {
            ...
            w(f, { x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 : b, anchorX: h ? r : g ? (2 * f.anchorX + c) / 3 : c, anchorY: h ? r : g ? (f.anchorY + d) / 2 : d });
            e.label.attr(f);
        ...
        getAnchor: function(a, b) {
            var c, d = this.chart, e = d.inverted, f = d.plotTop, g = d.plotLeft, h = 0, i = 0, k, j, a = pa(a);
            c = a[0].tooltipPos;
            ...
            c || (n(a, function(a) {
                ...
                i += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) +
                (!e && k ? k.top - f : 0);
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                k = ["x", d.chartWidth, a, c.plotX + d.plotLeft],
                j = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative),
                m = function(a, b, c, d) {
                    var h = c < d - e, i = d + e + c < b, k = d - e - c;
                    d += e;
                    if (j && i)f[a] = d;
                    else if (!j && h)f[a] = k;
                    else if (h)f[a] = k - g < 0 ? k : k - g;
                    else if (i)
                        f[a] =
                            d + g + c > b ? d : d + g;
                    else return!1;
                ...
                q = function() { m.apply(0, i) !== !1 ? l.apply(0, k) === !1 && !h && (o(!0), q()) : h ? f.x = f.y = 0 : (o(!0), q()) };
        ...
        refresh: function(a, b) {
            ...
            f = h[0];
            g = h[1];
            l && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, i && n(i, function(a) { a.setState() }), n(a, function(a) {
                a.setState("hover");
            ...
            k === !1 ? this.hide() : (this.isHidden && (ab(d), d.attr("opacity", 1).show()), d.attr({ text: k }), m = e.borderColor || a.color || i.color || "#606060", d.attr({ stroke: m }), this.updatePosition({ plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow, h: h[2] || 0 }), this.isHidden = !1);
        ...
        updatePosition: function(a) {
            var b = this.chart,
                ...
                c = (this.options.positioner || this.getPosition).call(this,
                    c.width, c.height, a);
            this.move(v(c.x), v(c.y || 0), a.plotX + b.plotLeft, a.plotY + b.plotTop);
        },
        getXDateFormat: function(a, b, c) {
            ...
            if (e) {
                ...
                for (f in I) {
                    if (e === I.week && +ka("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") {
                        f = "week";
                        break;
                    } else if (I[f] > e) {
                        f = i;
    ...
    var xa;
    $a = C.documentElement.ontouchstart !== r;
    var Xa = A.Pointer = function(a, b) { this.init(a, b) };
    Xa.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (A.Tooltip && b.tooltip.enabled)
                a.tooltip = new Lb(a, b.tooltip), this.followTouchMove =
        ...
        normalize: function(a, b) {
            ...
            d.pageX === r ? (c = x(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, d = d.pageY - b.top);
            return w(a, { chartX: v(c), chartY: v(d) });
        },
        ...
        runPointActions: function(a) {
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f = b.hoverPoint, g = b.hoverSeries, h, i = b.chartWidth, k, j, m = [], l, o;
            ...
            !e && g && g.directTouch && f ? l = f : (n(c, function(b) {
                ...
                if (a &&
                    typeof a.dist === "number" && a.dist < i)i = a.dist, l = a;
            }));
            if (l && (l !== this.prevKDPoint || d && d.isHidden)) {
                if (e && !l.series.noSharedTooltip) {
                    ...
                    n(m, function(b) { if (b !== l)b.onMouseOver(a) });
            ...
            if (d && !this._onDocumentMouseMove)this._onDocumentMouseMove = function(a) { if (ca[xa])ca[xa].pointer.onDocumentMouseMove(a) }, D(C, "mousemove", this._onDocumentMouseMove);
            n(b.axes, function(b) { b.drawCrosshair(a, p(l, f)) });
        },
        reset: function(a, b) {
            var c = this.chart, d = c.hoverSeries, e = c.hoverPoint, f = c.hoverPoints, g = c.tooltip, h = g && g.shared ? f : e;
            (a = a && g && h) && pa(h)[0].plotX === r && (a = !1);
            if (a)
                g.refresh(h), e && (e.setState(e.state, !0), n(c.axes, function(a) {
                    p(a.options.crosshair && a.options.crosshair.snap, !0) ? a.drawCrosshair(null,
                        e) : a.hideCrosshair();
                }));
            else {
                if (e)e.onMouseOut();
                f && n(f, function(a) { a.setState() });
                if (d)d.onMouseOut();
                g && g.hide(b);
                if (this._onDocumentMouseMove)T(C, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
                n(c.axes, function(a) { a.hideCrosshair() });
        ...
        scaleGroups: function(a, b) {
            ...
            n(c.series, function(e) {
                d = a || e.getPlotBox();
                e.xAxis && e.xAxis.zoomEnabled && (e.group.attr(d), e.markerGroup && (e.markerGroup.attr(d), e.markerGroup.clip(b ? c.clipRect :
                    null)), e.dataLabelsGroup && e.dataLabelsGroup.attr(d));
            });
        ...
        drag: function(a) {
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, k = b.plotWidth, j = b.plotHeight, m, l = this.mouseDownX, o = this.mouseDownY, q = c.panKey && a[c.panKey + "Key"];
            d < h ? d = h : d > h + k && (d = h + k);
            e < i ? e = i : e > i +
                j && (e = i + j);
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && m && !q && !this.selectionMarker)this.selectionMarker = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({ fill: c.selectionMarkerFill || "rgba(69,114,167,0.25)", zIndex: 7 }).add();
                this.selectionMarker && f && (d -= l, this.selectionMarker.attr({ width: Q(d), x: (d > 0 ? 0 : d) + l }));
                this.selectionMarker && g && (d = e - o, this.selectionMarker.attr({ height: Q(d), y: (d > 0 ? 0 : d) + o }));
        ...
        drop: function(a) {
            ...
            if (this.selectionMarker) {
                var e = { xAxis: [], yAxis: [], originalEvent: a.originalEvent || a }, f = this.selectionMarker, g = f.attr ? f.attr("x") : f.x, h = f.attr ? f.attr("y") : f.y, i = f.attr ? f.attr("width") : f.width, k = f.attr ? f.attr("height") : f.height, j;
                if (this.hasDragged || d)
                    ...
                    }), j && F(c, "selection", e, function(a) { c.zoom(w(a, d ? { animation: !1 } : null)) });
        ...
        onContainerClick: function(a) {
            var b = this.chart,
                ...
                a = this.normalize(a);
            a.originalEvent = a;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (F(c.series, "click", w(a, { point: c })), b.hoverPoint && c.firePointEvent("click", a)) : (w(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && F(b, "click", a)));
        },
        setDOMEvents: function() {
            ...
            if ($a)b.ontouchstart = function(b) { a.onContainerTouchStart(b) }, b.ontouchmove = function(b) { a.onContainerTouchMove(b) }, gb === 1 && D(C, "touchend", a.onDocumentTouchEnd);
        },
        destroy: function() {
            var a;
    ...
    w(A.Pointer.prototype,
    {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            ...
            w ? (v -= 0.8 * (v - g[k][0]), y || (x -= 0.8 * (x - g[k][1])), c()) : g[k] = [v, x];
            n || (f[k] = s - o, f[l] = q);
            f = n ? 1 / p : p;
            e[l] = q;
            e[k] = b;
            d[n ? a ? "scaleY" : "scaleX" : "scale" + j] = p;
            d["translate" + j] = f * o + (v - f * r);
        },
        pinch: function(a) {
            var b = this,
                c = b.chart,
            ...
            Aa(e, function(a) { return b.normalize(a) });
            if (a.type === "touchstart")
                n(e, function(a, b) { d[b] = { chartX: a.chartX, chartY: a.chartY } }), g.x = [d[0].chartX, d[1] && d[1].chartX], g.y = [d[0].chartY, d[1] && d[1].chartY], n(c.axes, function(a) {
                        if (a.zoomEnabled) {
                            var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min, a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = B(e, f), e = x(e, f);
                            b.min = B(a.pos, g - d);
                ...
                if (!i)b.selectionMarker = i = w({ destroy: ha }, c.plotBox);
        ...
        onDocumentTouchEnd: function(a) { ca[xa] && ca[xa].pointer.drop(a) }
    });
    if (S.PointerEvent || S.MSPointerEvent) {
        var Ba = {},
            ...
            hc = function() {
                ...
                for (a in Ba)Ba.hasOwnProperty(a) && b.push({ pageX: Ba[a].pageX, pageY: Ba[a].pageY, target: Ba[a].target });
                return b;
            },
            Nb = function(a, b, c, d) {
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) &&
                    ca[xa])d(a), d = ca[xa].pointer, d[b]({ type: c, target: a.currentTarget, preventDefault: ha, touches: hc() });
            };
        w(Xa.prototype, {
            onContainerPointerDown: function(a) { Nb(a, "onContainerTouchStart", "touchstart", function(a) { Ba[a.pointerId] = { pageX: a.pageX, pageY: a.pageY, target: a.currentTarget } }) },
            onContainerPointerMove: function(a) {
                Nb(a, "onContainerTouchMove", "touchmove", function(a) {
                    Ba[a.pointerId] = { pageX: a.pageX, pageY: a.pageY };
                    if (!Ba[a.pointerId].target)Ba[a.pointerId].target = a.currentTarget;
                });
            },
            onDocumentPointerUp: function(a) {
                Nb(a,
                    "onDocumentTouchEnd", "touchend", function(a) { delete Ba[a.pointerId] });
            },
    ...
    var tb = A.Legend = function(a, b) { this.init(a, b) };
    tb.prototype = {
        init: function(a, b) {
            var c = this, d = b.itemStyle, e = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled)
                c.itemStyle = d, c.itemHiddenStyle = z(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16),
        ...
        positionCheckboxes: function(a) {
            ...
            if (b)
                c = b.translateY, n(this.allItems, function(e) {
                    var f = e.checkbox, g;
                    f && (g = c + f.y + (a || 0) + 3, M(f, { left: b.translateX + e.checkboxOffset + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : Z }));
                });
        },
        ...
        renderItem: function(a) {
            ...
            if (e && this.itemX - s + f > (l || b.chartWidth - 2 * k - s - d.x))this.itemX = s, this.itemY += q + this.lastLineHeight + o, this.lastLineHeight = 0;
            this.maxItemWidth = x(this.maxItemWidth, f);
            this.lastItemY = q + this.itemY + o;
            this.lastLineHeight = x(g, this.lastLineHeight);
            a._legendItemPos = [this.itemX, this.itemY];
            e ? this.itemX += f : (this.itemY += q + g + o, this.lastLineHeight =
                g);
            this.offsetWidth = l || x((e ? this.itemX - s - j : f) + k, this.offsetWidth);
        },
        getAllItems: function() {
            var a = [];
            n(this.chart.series, function(b) {
                var c = b.options;
                if (p(c.showInLegend, !u(c.linkedTo) ? r : !1, !0))a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b));
            });
            return a;
        },
        adjustMargins: function(a, b) {
            ...
            this.display && !d.floating && n([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
                f.test(e) && !u(a[g]) && (c[pb[g]] =
                    x(c[pb[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + p(d.margin, 12) + b[g]));
            });
        },
        render: function() {
        ...
        handleOverflow: function(a) {
            ...
            if (a > f) {
                ...
                this.fullHeight = a;
                n(E, function(a, b) {
                    var c = a._legendItemPos[1], d = v(a.legendItem.getBBox().height), e = o.length;
                    if (!e || c - o[e - 1] > h && (s || c) !== o[e - 1])o.push(s || c), e++;
                    b === E.length - 1 && c + d - o[e - 1] > h && o.push(c);
                    c !== s && (s =
                        c);
                });
                if (!i)i = b.clipRect = d.clipRect(0, q, 9999, 0), b.contentGroup.clip(i);
                $(h);
                if (!l)this.nav = l = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, m, m).on("click", function() { b.scroll(-1, j) }).add(l), this.pager = d.text("", 15, 10).css(k.style).add(l), this.down = d.symbol("triangle-down", 0, 0, m, m).on("click", function() { b.scroll(1, j) }).add(l);
                b.scroll(0);
                a = f;
            } else if (l)$(c.chartHeight), l.hide(), this.scrollGroup.attr({ translateY: 1 }), this.clipHeight = 0;
            return a;
        },
        scroll: function(a, b) {
            var c = this.pages,
            ...
            e > d && (e = d);
            if (e > 0)
                b !== r && Ya(b, this.chart), this.nav.attr({ translateX: k, translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible" }), this.up.attr({ fill: e === 1 ? g : h }).css({ cursor: e === 1 ? "default" : "pointer" }), i.attr({ text: e + "/" + d }), this.down.attr({ x: 18 + this.pager.getBBox().width, fill: e === d ? g : h }).css({ cursor: e === d ? "default" : "pointer" }), c = -c[e - 1] + this.initialItemY,
    ...
    H = A.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            d = a.symbolWidth;
            var e = this.chart.renderer, f = this.legendGroup, a = a.baseline - v(a.fontMetrics.b * 0.3), g;
            if (b.lineWidth) {
    ...
    (/Trident\/7\.0/.test(Ha) || Va) && R(tb.prototype, "positionItem", function(a, b) {
        var c = this, d = function() { b._legendItemPos && a.call(c, b) };
        d();
        setTimeout(d);
    });
    var Pa = A.Chart = function() { this.init.apply(this, arguments) };
    Pa.prototype = {
        callbacks: [],
        init: function(a, b) {
            var c, d = a.series;
            ...
            ca.push(f);
            gb++;
            d.reflow !== !1 && D(f, "load", function() { f.initReflow() });
        ...
        initSeries: function(a) {
            ...
            (b = G[a.type || b.type || b.defaultSeriesType]) || qa(17, !0);
            b = new b;
            b.init(this, a);
            return b;
        },
        ...
        redraw: function(a) {
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, k = this.isDirtyBox, j = c.length, m = j, l = this.renderer, o = l.isHidden(), q = [];
            Ya(a, this);
            ...
            n(c, function(a) { a.isDirty && a.options.legendType === "point" && (a.updateTotals && a.updateTotals(), f = !0) });
            if (f && e.options.enabled)e.render(), this.isDirtyLegend = !1;
            g && this.getStacks();
            if (i && !this.isResizing)this.maxTicks = null, n(b, function(a) { a.setScale() });
            this.getMargins();
            i && (n(b, function(a) { a.isDirty && (k = !0) }), n(b, function(a) {
                if (a.isDirtyExtremes)
                    a.isDirtyExtremes =
                        !1, q.push(function() {
                        F(a, "afterSetExtremes", w(a.eventArgs, a.getExtremes()));
                        delete a.eventArgs;
                    });
                (k || g) && a.redraw();
            }));
        ...
        getAxes: function() {
            ...
            c = c.concat(b);
            n(c, function(b) { new J(a, b) });
        },
        getSelectedPoints: function() {
            var a = [];
            n(this.series, function(b) { a = a.concat(hb(b.points || [], function(a) { return a.selected })) });
            return a;
        },
        getSelectedSeries: function() { return hb(this.series, function(a) { return a.selected }) },
        getStacks: function() {
            var a = this;
        ...
        layOutTitles: function(a) {
            ...
            d && (d.css({ width: (e.width || h) + "px" }).align(w({
        ...
        getChartSize: function() {
            ...
            if (!u(b))this.containerWidth = qb(c, "width");
            if (!u(a))this.containerHeight = qb(c, "height");
            this.chartWidth = x(0, b || this.containerWidth || 600);
            this.chartHeight = x(0, p(a, this.containerHeight >
        ...
        getContainer: function() {
            ...
            c = this.chartWidth;
            d = this.chartHeight;
            this.container = a = aa(Ua, { className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e }, w({
                position: "relative",
                overflow: "hidden",
                width: c +
                    "px",
        ...
        getMargins: function(a) {
            ...
            this.resetMargins();
            if (d && !u(c[0]))this.plotTop = x(this.plotTop, d + this.options.title.margin + b[0]);
        ...
        getAxisMargins: function() {
            ...
            a.hasCartesianSeries && n(a.axes, function(a) { a.getOffset() });
            n(pb, function(d, e) { u(c[e]) || (a[d] += b[e]) });
            a.setChartSize();
        },
        reflow: function(a) {
            var b = this,
        ...
        initReflow: function() {
            ...
            D(S, "resize", b);
            D(a, "destroy", function() { T(S, "resize", b) });
        },
        setSize: function(a, b, c) {
            var d = this, e, f, g;
            d.isResizing += 1;
            g = function() { d && F(d, "endResize", null, function() { d.isResizing -= 1 }) };
            Ya(c, d);
            d.oldChartHeight =
                d.chartHeight;
            d.oldChartWidth = d.chartWidth;
            if (u(a))d.chartWidth = e = x(0, v(a)), d.hasUserSize = !!e;
            if (u(b))d.chartHeight = f = x(0, v(b));
            (Ga ? rb : M)(d.container, { width: e + "px", height: f + "px" }, Ga);
            d.setChartSize(!0);
        ...
        setChartSize: function(a) {
            ...
            this.plotTop = k = v(this.plotTop);
            this.plotWidth = j = x(0, v(d - i - this.marginRight));
            this.plotHeight = m = x(0, v(e - k - this.marginBottom));
            ...
            b = za(x(d, h[3]) / 2);
            c = za(x(d, h[0]) / 2);
            this.clipBox = { x: b, y: c, width: W(this.plotSizeX - x(d, h[1]) / 2 - b), height: x(0, W(this.plotSizeY - x(d, h[2]) / 2 - c)) };
        ...
        resetMargins: function() {
            var a = this;
            n(pb, function(b, c) { a[b] = p(a.margin[c], a.spacing[c]) });
        ...
        drawChartBox: function() {
            ...
            if (j)
                f ?
                    f.animate(t) : this.plotBackground = b.rect(q, s, n, p, 0).attr({ fill: j }).add().shadow(a.plotShadow);
            if (m)h ? h.animate(t) : this.plotBGImage = b.image(m, q, s, n, p).add();
            y ? y.animate({ width: r.width, height: r.height }) : this.clipRect = b.clipRect(r);
            if (l)g ? g.animate(g.crisp({ x: q, y: s, width: n, height: p, strokeWidth: -l })) : this.plotBorder = b.rect(q, s, n, p, 0, -l).attr({ stroke: a.plotBorderColor, "stroke-width": l, fill: Z, zIndex: 1 }).add();
            this.isDirtyBox = !1;
        },
        ...
        renderLabels: function() {
            ...
            b.items && n(b.items, function(c) {
                var d = w(b.style, c.style), e = L(d.left) + a.plotLeft, f = L(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
        ...
        render: function() {
            ...
            if (f || g)this.maxTicks = null, n(a, function(a) { (a.horiz && f || !a.horiz && g) && a.setTickInterval(!0) }), this.getMargins();
            this.drawChartBox();
            this.hasCartesianSeries && n(a, function(a) { a.render() });
        ...
        isReadyToRender: function() {
            var a = this;
            return!ea && S == S.top && C.readyState !== "complete" || ma && !S.canvg ? (ma ? Wb.push(function() { a.firstRender() }, a.options.global.canvasToolsURL) : C.attachEvent("onreadystatechange", function() {
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender()) {
                ...
                a.renderer.draw();
                c && c.apply(a, [a]);
                n(a.callbacks, function(b) { a.index !== r && b.apply(a, [a]) });
                F(a, "load");
                a.cloneRenderTo(!0);
            }
        },
    ...
    var ic = A.CenteredSeriesMixin =
        {
            getCenter: function() {
                var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d = b.plotWidth - 2 * c, b = b.plotHeight - 2 * c, e = a.center, e = [p(e[0], "50%"), p(e[1], "50%"), a.size || "100%", a.innerSize || 0], f = B(d, b), g, h;
    ...
    Ca.prototype = {
        init: function(a, b, c) {
            ...
            this.pointAttr = {};
            if (a.options.colorByPoint && (b = a.options.colors ||
                a.chart.options.colors, this.color = this.color || b[a.colorCounter++], a.colorCounter === b.length))a.colorCounter = 0;
            a.chart.pointCount++;
            return this;
        },
        applyOptions: function(a, b) {
            var c = this.series, d = c.options.pointValKey || c.pointValKey, a = Ca.prototype.optionsToObject.call(this, a);
            w(this, a);
        ...
        firePointEvent: function(a, b, c) {
            ...
            a === "click" && e.allowPointSelect && (c = function(a) {
                d.select && d.select(null, a.ctrlKey || a.metaKey ||
                    a.shiftKey);
            });
            F(this, a, b, c);
        }
    ...
    O.prototype = {
        ...
        parallelArrays: ["x", "y"],
        init: function(a, b) {
            var c = this, d, e, f = a.series, g = function(a, b) { return p(a.options.index, a._i) - p(b.options.index, b._i) };
            c.chart = a;
            ...
            c.getColor();
            c.getSymbol();
            n(c.parallelArrays, function(a) { c[a + "Data"] = [] });
            c.setData(b.data, !1);
        ...
        autoIncrement: function() {
            ...
            if (d === "month" || d === "year")a = new fa(b), a = d === "month" ? +a[Eb](a[db]() + c) : +a[Fb](a[eb]() + c), c = a - b;
            this.xIncrement = b + c;
            return b;
        },
        ...
        getColor: function() { this.options.colorByPoint || this.getCyclic("color", this.options.color || U[this.type].color, this.chart.options.colors) },
        getSymbol: function() {
            var a =
                this.options.marker;
        ...
        setData: function(a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, k = e.chart, j = null, m = e.xAxis, l = m && !!m.categories, o = i.turboThreshold, q = this.xData, s = this.yData, E = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
                ...
                e.colorCounter = 0;
                n(this.parallelArrays, function(a) { e[a + "Data"].length = 0 });
                if (o && h > o) {
                    for (c = 0; j === null && c < h;)j = a[c], c++;
                    if (sa(j)) {
                        l = p(i.pointStart, 0);
                        i = p(i.pointInterval, 1);
                        for (c = 0; c < h; c++)q[c] = l, s[c] = a[c], l += i;
                        e.xIncrement = l;
                    } else if (Ka(j))
                        if (E)for (c = 0; c < h; c++)i = a[c], q[c] = i[0], s[c] = i.slice(1, E + 1);
                        else for (c = 0; c < h; c++)i = a[c], q[c] = i[0], s[c] = i[1];
                    else qa(12);
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== r && (i = { series: e }, e.pointClass.prototype.applyOptions.apply(i,
                        [a[c]]), e.updateParallelArrays(i, c), l && i.name))m.names[i.x] = i.name;
                Ja(s[0]) && qa(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        generatePoints: function() {
            ...
            for (l = 0; l < g; l++)
                i = h + l, k ? m[l] = (new f).init(this, [d[l]].concat(pa(e[l]))) : (b[i] ? j = b[i] : a[i] !== r && (b[i] = j = (new f).init(this,
                    a[i], d[l])), m[l] = j), m[l].index = i;
            if (b && (g !== (c = b.length) || k))for (l = 0; l < c; l++)if (l === h && !k && (l += g), b[l])b[l].destroyElements(), b[l].plotX = r;
            this.data = b;
            this.points = m;
        },
        getExtremes: function(a) {
            ...
            d = a.length;
            for (m = 0; m < d; m++)
                if (k = c[m], j = a[m], i = j !== null && j !== r && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped ||
                (c[m + 1] || k) >= g && (c[m - 1] || k) <= h, i && k)
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i === "between" || sa(i), j = a.threshold, m = a.startFromThreshold ? j : 0, l, o, q, s = Number.MAX_VALUE, a = 0; a < g; a++) {
                var n = f[a], $ = n.x, t = n.y;
                o = n.low;
                var y =
                    b && e.stacks[(this.negStacks && t < (m ? 0 : j) ? "-" : "") + this.stackKey];
                if (e.isLog && t !== null && t <= 0)n.y = t = null, qa(10);
                n.plotX = l = B(x(-1E5, c.translate($, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
                if (b && this.visible && y && y[$])y = y[$], t = y.points[this.index + "," + a], o = t[0], t = t[1], o === m && (o = p(j, e.min)), e.isLog && o <= 0 && (o = null), n.total = n.stackTotal = y.total, n.percentage = y.total && n.y / y.total * 100, n.stackY = t, y.setOffset(this.pointXOffset || 0, this.barW || 0);
                n.yBottom = u(o) ? e.translate(o, 0, 1, 0, 1) : null;
                h && (t = this.modifyValue(t, n));
                n.plotY =
                    o = typeof t === "number" && t !== Infinity ? B(x(-1E5, e.translate(t, 0, 1, 0, 1)), 1E5) : r;
                n.isInside = o !== r && o >= 0 && o <= e.len && l >= 0 && l <= c.len;
                n.clientX = k ? c.translate($, 0, 0, 0, 1) : l;
                n.negative = n.y < (j || 0);
                n.category = d && d[n.x] !== r ? d[n.x] : n.x;
                a && (s = B(s, Q(l - q)));
                q = l;
            }
        ...
        drawPoints: function() {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, k, j, m = this.options.marker, l = this.pointAttr[""], o, q, s, n = this.markerGroup, $ = p(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
            if (m.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = W(g.plotX), e = g.plotY, j = g.graphic, o = g.marker || {}, q = !!g.marker, a = $ && o.enabled === r ||
                        o.enabled, s = g.isInside, a && e !== r && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(o.symbol, this.symbol), k = i.indexOf("url") === 0, j)j[s ? "show" : "hide"](!0).animate(w({ x: d - h, y: e - h }, j.symbolName ? { width: 2 * h, height: 2 * h } : {}));
                        else {
                            if (s && (h > 0 || k))g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? o : m).attr(a).add(n);
                        }
        ...
        getAttribs: function() {
            ...
            k = b.turboThreshold;
            var s = a.zones, p = a.zoneAxis || "y", r;
            ...
            if (!k || g < k || m)
                for (; g--;) {
                    ...
                    if (s.length) {
                        m = 0;
                        for (f = s[m]; k[p] >= f.value;)f = s[++m];
                        k.color = k.fillColor = f.color;
                    }
                    m = b.colorByPoint || k.color;
                    if (k.options)for (r in l)u(c[l[r]]) && (m = !0);
                    if (m) {
                        c = c || {};
                        m = [];
                        d = c.states || {};
                        f = d.hover =
                            d.hover || {};
                        if (!b.marker)f.color = f.color || !k.options.color && e[k.negative && h ? "negativeColor" : "color"] || wa(k.color).brighten(f.brightness || e.brightness).get();
                        f = { color: k.color };
                        if (!q)f.fillColor = k.color;
                        if (!o)f.lineColor = k.color;
                        c.hasOwnProperty("color") && !c.color && delete c.color;
                        m[""] = a.convertAttribs(w(f, c), j[""]);
                        m.hover = a.convertAttribs(d.hover, j.hover, m[""]);
                        m.select = a.convertAttribs(d.select, j.select, m[""]);
                    } else m = j;
                    k.pointAttr = m;
                }
        },
        destroy: function() {
            ...
            F(a, "destroy");
            T(a);
            n(a.axisTypes || [], function(b) { if (h = a[b])ua(h.series, a), h.isDirty = h.forceRedraw = !0 });
        ...
        drawGraph: function() {
            ...
            n(this.zones, function(d, e) { c.push(["zoneGraph" + e, d.color || a.color, d.dashStyle || b.dashStyle]) });
            n(c, function(c, i) {
                var k = c[0], j = a[k];
                if (j)ab(j), j.animate({ d: f });
                else if ((d || g) && f.length)
                    j = { stroke: c[1], "stroke-width": d, fill: g, zIndex: 1 }, c[2] ? j.dashstyle = c[2] : e && (j["stroke-linecap"] = j["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(f).attr(j).add(a.group).shadow(i < 2 &&
                        b.shadow);
            });
        },
        applyZones: function() {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph, k = this.area, j = x(b.chartWidth, b.chartHeight), m = this[(this.zoneAxis || "y") + "Axis"], l, o = m.reversed, q = b.inverted, s = m.horiz, E, r, t, y = !1;
            if (d.length && (i || k))
                i && i.hide(), k && k.hide(), l = m.getExtremes(), n(d, function(d, n) {
                    e = o ? s ? b.plotWidth : 0 : s ? 0 : m.toPixels(l.min);
                    e = B(x(p(f, e), 0), j);
                    f = B(x(v(m.toPixels(p(d.value, l.max), !0)), 0), j);
                    ...
                    if (m.isXAxis) {
                        if (h =
                        { x: q ? t : r, y: 0, width: E, height: j }, !s)h.x = b.plotHeight - h.x;
                    } else if (h = { x: 0, y: q ? t : r, width: j, height: E }, s)h.y = b.plotWidth - h.y;
                    b.inverted && c.isVML && (h = m.isXAxis ? { x: 0, y: o ? r : t, height: h.width, width: b.chartWidth } : { x: h.y - b.plotLeft - b.spacingBox.x, y: 0, width: h.height, height: b.chartHeight });
        ...
        invertGroups: function() {
            ...
            if (b.xAxis)D(c, "resize", a), D(b, "destroy", function() { T(c, "resize", a) }), a(), b.invertGroups = a;
        },
        ...
        render: function() {
            ...
            n(a.points, function(a) { a.redraw && a.redraw() });
            a.drawDataLabels &&
                a.drawDataLabels();
        ...
        searchKDTree: function(a, b) {
            function c(a, b, k, j) {
                var m = b.point, l = d.kdAxisArray[k % j], o, q, s = m;
                q = u(a[e]) && u(m[e]) ? Math.pow(a[e] - m[e], 2) : null;
                o = u(a[f]) && u(m[f]) ? Math.pow(a[f] - m[f], 2) : null;
                o = (q || 0) + (o || 0);
                m.dist = u(o) ? Math.sqrt(o) :
                    Number.MAX_VALUE;
                m.distX = u(q) ? Math.sqrt(q) : Number.MAX_VALUE;
                l = a[l] - m[l];
                o = l < 0 ? "left" : "right";
                q = l < 0 ? "right" : "left";
                b[o] && (o = c(a, b[o], k + 1, j), s = o[g] < s[g] ? o : m);
                b[q] && Math.sqrt(l * l) < s[g] && (a = c(a, b[q], k + 1, j), s = a[g] < s[g] ? a : s);
                return s;
            }
    ...
    O.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (r = 0; r < d; r++) {
                ...
                s = (q = j && y < (g ? 0 : f)) ? k : i;
                l[s] || (l[s] = {});
                if (!l[s][t])o[s] && o[s][t] ? (l[s][t] = o[s][t], l[s][t].total = null) : l[s][t] = new Tb(m, m.options.stackLabels, q, t, h);
                s = l[s][t];
                s.points[n] = [p(s.cum, g)];
                e === "percent" ? (q = q ? i : k, j && l[q] && l[q][t] ? (q = l[q][t], s.total = q.total = x(q.total, s.total) + Q(y) || 0) : s.total = la(s.total + (Q(y) || 0))) : s.total = la(s.total + (y || 0));
                s.cum = p(s.cum,
                    g) + (y || 0);
                s.points[n].push(s.cum);
                c[r] = s.cum;
            }
    ...
    w(Pa.prototype, {
        ...
        showLoading: function(a) {
            var b = this, c = b.options, d = b.loadingDiv, e = c.loading, f = function() { d && M(d, { left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px" }) };
            if (!d)
                b.loadingDiv = d = aa(Ua, { className: "highcharts-loading" },
                    w(e.style, { zIndex: 10, display: Z }), b.container), b.loadingSpan = aa("span", null, e.labelStyle, d), D(b, "redraw", f);
            b.loadingSpan.innerHTML = a || c.lang.loading;
            if (!b.loadingShown)M(d, { opacity: 0, display: "" }), rb(d, { opacity: e.style.opacity }, { duration: e.showDuration || 0 }), b.loadingShown = !0;
            f();
        },
        hideLoading: function() {
            var a = this.options, b = this.loadingDiv;
            b && rb(b, { opacity: 0 }, { duration: a.loading.hideDuration || 100, complete: function() { M(b, { display: Z }) } });
            this.loadingShown = !1;
        }
    });
    w(Ca.prototype, {
    ...
    w(O.prototype, {
        ...
        removePoint: function(a, b, c) {
            var d = this, e = d.data, f = e[a], g = d.points, h = d.chart,
                i = function() {
        ...
        remove: function(a, b) {
            ...
            if (!c.isRemoving)
                c.isRemoving = !0, F(c, "remove", null, function() {
                    c.destroy();
        ...
        update: function(a, b) {
            var c = this, d = this.chart, e = this.userOptions, f = this.type, g = G[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"], i;
            ...
            this.remove(!1);
            for (i in g)this[i] = r;
            w(this, G[a.type || f].prototype);
            n(h, function(a) { c[a] = h[a] });
            this.init(d, a);
            d.linkSeries();
            p(b,
                !0) && d.redraw(!1);
    ...
    var ya = ja(O, {
        type: "area",
        getSegments: function() {
            var a = this, b = [], c = [], d = [], e = this.xAxis, f = this.yAxis, g = f.stacks[this.stackKey], h = {}, i, k, j = this.points, m = this.options.connectNulls, l, o;
            if (this.options.stacking && !this.cropped) {
                for (l = 0; l < j.length; l++)h[j[l].x] = j[l];
                ...
                n(d, function(b) {
                    ...
                    if (!m || h[b] && h[b].y !== null)
                        if (h[b])c.push(h[b]);
                            ...
                            i = e.translate(b);
                            k = f.toPixels(d, !0);
                            c.push({ y: null, plotX: i, clientX: i, plotY: k, yBottom: k, onMouseOver: ha });
                        }
                });
                c.length && b.push(c);
        ...
        drawGraph: function() {
            ...
            n(d, function(d) {
                var f = d[0], g = a[f];
                g ? g.animate({ d: b }) : a[f] = a.chart.renderer.path(b).attr({ fill: p(d[2], wa(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()), zIndex: 0 }).add(a.group);
            });
        },
    ...
    Da = ja(O, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                i += m;
                j += m;
                i > a && i > e ? (i = x(a, e), j = 2 * e - i) : i < a && i < e && (i = B(a, e), j = 2 * e - i);
    ...
    G.areaspline = Da;
    U.column = z(N, { borderColor: "#FFFFFF", borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: { hover: { brightness: 0.1, shadow: !1, halo: !1 }, select: { color: "#C0C0C0", borderColor: "#000000", shadow: !1 } }, dataLabels: { align: null, verticalAlign: null, y: null }, startFromThreshold: !0, stickyTracking: !1, tooltip: { distance: 6 }, threshold: 0 });
    Da = ja(O, {
        type: "column",
        pointAttrToOptions: {
            stroke: "borderColor",
        ...
        getColumnMetrics: function() {
            ...
            var c = B(Q(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), k = c * b.groupPadding, j = (c - 2 * k) / i, m = b.pointWidth, b = u(m) ? (j - m) / 2 : j * b.pointPadding, m = p(m, j - 2 * b);
            return a.columnMetrics = { width: m, offset: b + (k + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * j - c / 2) * (e ? -1 : 1) };
        },
        translate: function() {
            var a = this,
                b = a.chart,
            ...
            n(a.points, function(c) {
                var d = p(c.yBottom, f), h = 999 + Q(d), h = B(x(-h, c.plotY), e.len + h), n = c.plotX + j, r = k, t = B(h, d), y, u;
                y = x(h, d) - t;
                Q(y) < g && g && (y = g, u = !e.reversed && !c.negative || e.reversed && c.negative, t = v(Q(t - f) > g ? d - g : f - (u ? g : 0)));
                c.barX = n;
                c.pointWidth = i;
                r = v(n + r) + m;
                n = v(n) + m;
                ...
                y -= t;
                d && (t -= 1, y += 1);
                c.tooltipPos = b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - n - r / 2, y] : [n + r / 2, h + e.pos - b.plotTop, y];
                c.shapeType = "rect";
                c.shapeArgs = { x: n, y: t, width: r, height: y };
            });
        },
        getSymbol: ha,
        drawLegendSymbol: H.drawRectangle,
        ...
        drawPoints: function() {
            ...
            n(a.points, function(h) {
                ...
                if (i !== r && !isNaN(i) && h.y !==
                    null)f = h.shapeArgs, i = u(a.borderWidth) ? { "stroke-width": a.borderWidth } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], k ? (ab(k), k.attr(i)[b.pointCount < e ? "animate" : "attr"](z(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
        ...
        animate: function(a) {
            ...
            if (ea)
                a ? (e.scaleY = 0.001, a = B(b.pos + b.len, x(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len :
    ...
    ya = ja(O, { type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], takeOrdinalPosition: !1, kdDimensions: 2, drawGraph: function() { this.options.lineWidth && O.prototype.drawGraph.call(this) } });
    G.scatter = ya;
    U.pie = z(N, {
        borderColor: "#FFFFFF",
        borderWidth: 1,
    ...
    N = {
        ...
        pointClass: ja(Ca, {
            ...
            setVisible: function(a, b) {
                var c = this,
                    ...
                    b = p(b, f);
                if (a !== c.visible) {
                    c.visible = c.options.visible = a = a === r ? !c.visible : a;
                    d.options.data[Oa(c, d.data)] = c.options;
                    n(["graphic", "dataLabel", "connector", "shadowGroup"], function(b) { if (c[b])c[b][a ? "show" : "hide"](!0) });
        ...
        translate: function(a) {
            ...
            var b = 0,
                ...
                h,
                i = c.startAngle || 0,
                k = this.startAngleRad = va / 180 * (i - 90),
                i = (this.endAngleRad = va / 180 * (p(c.endAngle, i + 360) - 90)) - k,
                j = this.points,
            ...
            for (l = 0; l < o; l++) {
                ...
                g = k + b * i;
                q.shapeType = "arc";
                q.shapeArgs = { x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: v(f * 1E3) / 1E3, end: v(g * 1E3) / 1E3 };
                h = (g + f) / 2;
                h > 1.5 * va ? h -= 2 * va : h < -va / 2 && (h += 2 * va);
                q.slicedTranslation = { translateX: v(ba(h) * d), translateY: v(ga(h) * d) };
                f = ba(h) * a[2] / 2;
                g = ga(h) * a[2] / 2;
                q.tooltipPos = [
                    a[0] + f * 0.7, a[1] +
    ...
    O.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels)
            a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (k.attr({ opacity: +h }), h || D(a, "afterAnimate", function() {
                a.visible && k.show();
                k[b.animation ? "animate" : "attr"]({ opacity: 1 }, { duration: 200 });
            })), g = d, n(e, function(e) {
                var h, o = e.dataLabel, q, s, n = e.connector, v = !0, t, y = {};
                ...
                if (o && !h)e.dataLabel = o.destroy();
                    ...
                    if (o)
                        if (u(i))o.attr({ text: i }), v = !1;
                        else {
                            if (e.dataLabel = o = o.destroy(), n)e.connector = n.destroy();
                        }
                    else if (u(i)) {
                        o = { fill: d.backgroundColor, stroke: d.borderColor, "stroke-width": d.borderWidth, r: d.borderRadius || 0, rotation: h, padding: d.padding, zIndex: 1 };
                        if (t.color === "contrast")
                            y.color =
                                d.inside || d.distance < 0 || b.stacking ? j.getContrast(e.color || a.color) : "#000000";
                        if (c)y.cursor = c;
                        for (s in o)o[s] === r && delete o[s];
                        o = e.dataLabel = j[h ? "text" : "label"](i, 0, -999, d.shape, null, null, d.useHTML).attr(o).css(w(t, y)).add(k).shadow(d.shadow);
                    }
                    o && a.alignDataLabel(e, o, d, null, v);
                }
            });
    };
    O.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart,
            ...
            m = this.visible && (a.series.forceDL || f.isInsidePlot(h,
                v(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (m)
            d = w({ x: g ? f.plotWidth - i : h, y: v(g ? f.plotHeight - h : i), width: 0, height: 0 }, d), w(c, { width: k.width, height: k.height }), c.rotation ? (a = f.renderer.rotCorr(j, c.rotation), b[e ? "attr" : "animate"]({ x: d.x + c.x + d.width / 2 + a.x, y: d.y + c.y + d.height / 2 }).attr({ align: c.align })) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (m = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)), c.shape &&
    ...
    if (G.pie)
        G.pie.prototype.drawDataLabels = function() {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, k, j, m = p(e.softConnector, !0), l = e.distance, o = a.center, q = o[2] / 2, s = o[1], r = l > 0, u, t, y, w = [[], []], z, A, D, C, K, G = [0, 0, 0, 0], L = function(a, b) { return b.y - a.y };
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                O.prototype.drawDataLabels.apply(a);
                n(b, function(a) { a.dataLabel && a.visible && w[a.half].push(a) });
                for (C = 2; C--;) {
                    var H =
                        [],
                        M = [],
                    ...
                    if (J) {
                        ...
                        if (l > 0) {
                            t = B(s + q + l, d.plotHeight);
                            for (K = x(0, s - q - l); K <= t; K += b)H.push(K);
                            t = H.length;
                            if (J > t) {
                                c = [].concat(I);
                                c.sort(L);
                            ...
                            for (K = 0; K < J; K++) {
                                ...
                                c = 9999;
                                var P, N;
                                for (N = 0; N < t; N++)P = Q(H[N] - y[1]), P < c && (c = P, F = N);
                                if (F < K && H[K] !== null)F = K;
                                else
                                    for (t < J - K + F && H[K] !== null && (F = t - J + K); H[F] ===
                                        null;)F++;
                                M.push({ i: F, y: H[F] });
                                H[F] = null;
                            }
                        ...
                        for (K = 0; K < J; K++) {
                            ...
                            c = y[1];
                            if (l > 0) {
                                if (t = M.pop(), F = t.i, A = t.y, c > A && H[F + 1] !== null || c < A && H[F - 1] !== null)A = B(x(0, c), d.plotHeight);
                            } else A = c;
                            z = e.justify ? o[0] + (C ? -1 : 1) * (q + l) : a.getX(A === s - q - l || A === s + q + l ? c : A, C);
                            u._attr = { visibility: D, align: y[6] };
                            u._pos = { x: z + e.x + ({ left: f, right: -f }[y[6]] || 0), y: A + e.y - 10 };
                            u.connX = z;
                            u.connY = A;
                            if (this.options.size === null)
                                t = u.width, z - t < f ? G[3] = x(v(t - z + f), G[3]) : z + t > h -
                                    f && (G[1] = x(v(z + t - h + f), G[1])), A - b / 2 < 0 ? G[0] = x(v(-A + b / 2), G[0]) : A + b / 2 > i && (G[2] = x(v(A + b / 2 - i), G[2]));
                        }
                    }
                }
                if (Fa(G) === 0 || this.verifyDataLabelOverflow(G))
                    this.placeDataLabels(), r && g && n(this.points, function(b) {
                        ...
                        if ((u = b.dataLabel) && u._pos && b.visible)
                            D = u._attr.visibility, z = u.connX, A = u.connY, j = m ? ["M", z + (y[6] === "left" ? 5 : -5), A, "C", z, A, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", z + (y[6] === "left" ? 5 : -5), A, "L", y[2], y[3], "L", y[4], y[5]], k ? (k.animate({ d: j }), k.attr("visibility", D)) : b.connector =
                                k = a.chart.renderer.path(j).attr({ "stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: D }).add(a.dataLabelsGroup);
        ...
        }, G.pie.prototype.alignDataLabel = ha, G.pie.prototype.verifyDataLabelOverflow = function(a) {
            var b = this.center,
                c = this.options,
                d = c.center,
                e = c.minSize ||
                ...
                f = e,
                g;
            d[0] !== null ? f = x(b[2] - x(a[1], a[3]), e) : (f = x(b[2] - a[1] - a[3], e), b[0] += (a[3] - a[1]) / 2);
            d[1] !== null ? f = x(B(f, b[2] - x(a[0], a[2])), e) : (f = x(B(f, b[2] - a[0] - a[2]), e), b[1] += (a[0] - a[2]) / 2);
            f < b[2] ? (b[2] = f, b[3] = /%$/.test(c.innerSize || 0) ? f * parseFloat(c.innerSize || 0) / 100 : parseFloat(c.innerSize || 0), this.translate(b), n(this.points, function(a) { if (a.dataLabel)a.dataLabel._pos = null }), this.drawDataLabels && this.drawDataLabels()) : g = !0;
            return g;
        };
    if (G.column)
        G.column.prototype.alignDataLabel = function(a, b, c, d, e) {
            var f =
                    this.chart.inverted,
                g = a.series,
            ...
            if (h && (d = z(h), f && (d = { x: g.yAxis.len - d.y - d.height, y: g.xAxis.len - d.x - d.width, width: d.height, height: d.width }), !k))f ? (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height : 0, d.height = 0);
    ...
    (function(a) {
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (d = 0; d < b; d++) {
                e = a[d];
                for (c = d + 1; c < b; ++c)if (j = a[c], e && j && e.placed && j.placed && e.newOpacity !== 0 && j.newOpacity !== 0 && !(j.alignAttr.x > e.alignAttr.x + e.width || j.alignAttr.x + j.width < e.alignAttr.x || j.alignAttr.y > e.alignAttr.y + e.height || j.alignAttr.y + j.height < e.alignAttr.y))(e.labelrank < j.labelrank ? e : j).newOpacity = 0;
            }
            for (d = 0; d < b; d++)
                if (c = a[d]) {
                    if (c.oldOpacity !== c.newOpacity && c.placed)
                        c.alignAttr.opacity = c.newOpacity, c[c.isOld && c.newOpacity ?
    ...
    var jb = A.TrackerMixin = {
        drawTrackerPoint: function() {
            var a = this, b = a.chart, c = b.pointer, d = a.options.cursor, e = d && { cursor: d },
                f = function(a) {
            ...
            if (!a._hasTracking)
                n(a.trackerGroups, function(b) {
                    if (a[b] && (a[b].addClass("highcharts-tracker").on("mouseover", f).on("mouseout",
                        function(a) { c.onTrackerMouseOut(a) }).css(e), $a))a[b].on("touchstart", f);
                }), a._hasTracking = !0;
        },
        drawTrackerGraph: function() {
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor, m = j && { cursor: j }, j = a.singlePoints, l, o = function() { if (f.hoverSeries !== a)a.onMouseOver() }, q = "rgba(192,192,192," + (ea ? 1.0E-4 : 0.002) + ")";
            if (e && !c)
                for (l = e + 1; l--;)
                    d[l] === "M" && d.splice(l + 1, 0, d[l + 1] - i, d[l + 2], "L"), (l && d[l] ===
                        "M" || l === e) && d.splice(l, 0, "L", d[l - 2] + i, d[l - 1]);
            for (l = 0; l < j.length; l++)e = j[l], d.push("M", e.plotX - i, e.plotY, "L", e.plotX + i, e.plotY);
            k ? k.attr({ d: d }) : (a.tracker = h.path(d).attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: q, fill: c ? q : Z, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 }).add(a.group), n([a.tracker, a.markerGroup], function(a) {
                a.addClass("highcharts-tracker").on("mouseover", o).on("mouseout", function(a) { g.onTrackerMouseOut(a) }).css(m);
                if ($a)a.on("touchstart", o);
            }));
        }
    };
    if (G.column)
        Da.prototype.drawTracker =
            jb.drawTrackerPoint;
    if (G.pie)G.pie.prototype.drawTracker = jb.drawTrackerPoint;
    if (G.scatter)ya.prototype.drawTracker = jb.drawTrackerPoint;
    w(tb.prototype, {
        setItemEvents: function(a, b, c, d, e) {
            ...
            (c ? b : a.legendGroup).on("mouseover", function() {
                ...
                a.firePointEvent ? a.firePointEvent("legendItemClick", b, c) : F(a, "legendItemClick",
                    b, c);
            });
        },
        createCheckboxForItem: function(a) {
            ...
            D(a.checkbox, "click", function(b) { F(a.series || a, "checkboxClick", { checked: b.target.checked, item: a }, function() { a.select() }) });
        }
    });
    ...
    w(Pa.prototype, {
        ...
        zoomOut: function() {
            var a = this;
            F(a, "selection", { resetSelection: !0 }, function() { a.zoom() });
        },
        zoom: function(a) {
            var b, c = this.pointer, d = !1, e;
            !a || a.resetSelection ? n(this.axes, function(a) { b = a.zoom() }) : n(a.xAxis.concat(a.yAxis), function(a) {
            ...
            n(b === "xy" ? [1, 0] : [1], function(b) {
                var d = a[b ? "chartX" : "chartY"],
                    ...
                    k = h.toValue(i + c[b ? "plotWidth" : "plotHeight"] -
                        d, !0) - k,
                    i = i > d;
                if (h.series.length && (i || m > B(j.dataMin, j.min)) && (!i || k < x(j.dataMax, j.max)))h.setExtremes(m, k, !1, !1, { trigger: "pan" }), e = !0;
    ...
    w(Ca.prototype, {
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", { accumulate: b }, function() {
                ...
                b || n(e.getSelectedPoints(), function(a) {
                    if (a.selected &&
                        a !== c)a.selected = a.options.selected = !1, d.options.data[Oa(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect");
                });
            });
        },
        ...
        setState: function(a, b) {
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = U[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], k = i && i.enabled === !1, j = e.stateMarkerGraphic, m = this.marker || {}, l = e.chart, o = e.halo, q, a = a || "";
            q = this.pointAttr[a] ||
                e.pointAttr[a];
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && m.states && m.states[a] && m.states[a].enabled === !1)) {
                if (this.graphic)g = g && this.graphic.symbolName && q.r, this.graphic.attr(z(q, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})), j && j.hide();
                else {
                    if (a && i)
                        if (g = i.radius, m = m.symbol || e.symbol, j && j.currentSymbol !== m && (j = j.destroy()), j)j[b ? "animate" : "attr"]({ x: c - g, y: d - g });
                        else if (m)
                            e.stateMarkerGraphic = j = l.renderer.symbol(m, c - g, d - g, 2 * g, 2 * g).attr(q).add(e.markerGroup),
                                j.currentSymbol = m;
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    o.attr(w({ fill: wa(this.color || e.color).setOpacity(c.opacity).get() }, c.attributes))[b ? "animate" : "attr"]({ d: this.haloPath(c.size) });
                } else o && o.attr({ d: [] });
                this.state = a;
            }
        },
    ...
    R(O.prototype, "init", function(a) {
        ...
        (b = this.xAxis) && b.options.ordinal && D(this, "updatedData", function() { delete b.ordinalIndex });
    });
    R(J.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        var i = 0, k = 0, j, m = {}, l, o, q, n = [], p = -Number.MAX_VALUE, v = this.options.tickPixelInterval;
        ...
        if (h && a.unitRange <= I.hour) {
            k = n.length - 1;
            for (i = 1; i < k; i++)ka("%d", n[i]) !== ka("%d", n[i - 1]) && (m[n[i]] = "day", l = !0);
            l && (m[n[0]] = "day");
            a.higherRanks = m;
        }
        n.info = a;
        if (h && u(v)) {
            ...
            for (l = []; h--;)i = this.translate(n[h]), t && (l[h] = t - i), k[h] = t = i;
            l.sort();
            l = l[W(l.length / 2)];
            l < v * 0.6 && (l = null);
            h = n[a - 1] > d ? a - 1 : a;
            for (t = void 0; h--;)i = k[h], d = t - i, t && d < v * 0.8 && (l === null || d < l * 0.8) ? (m[n[h]] && !m[n[h + 1]] ? (d = h + 1, t = i) : d = h, n.splice(d, 1)) : t = i;
        }
        return n;
    });
    w(J.prototype, {
            ...
            if ((e = this.options.ordinal) || i) {
                n(this.series, function(c, d) {
                    if (c.visible !== !1 && (c.takeOrdinalPosition !== !1 || i))
                        if (b = b.concat(c.processedXData), a = b.length, b.sort(function(a, b) { return a - b }), a)
                            for (d = a - 1; d--;)
                                b[d] ===
                                    b[d + 1] && b.splice(d, 1);
                });
                ...
                c ? (this.ordinalPositions = b, d = this.val2lin(x(f, b[0]), !0), h = x(this.val2lin(B(g, b[b.length - 1]), !0), 1), this.ordinalSlope = g = (g - f) / (h - d), this.ordinalOffset = f - d * g) : this.ordinalPositions = this.ordinalSlope = this.ordinalOffset = r;
            }
        ...
        getExtendedPositions: function() {
            ...
            if (!c[d])
                f = { series: [], getExtremes: function() { return{ min: e.dataMin, max: e.dataMax } }, options: { ordinal: !0 }, val2lin: J.prototype.val2lin }, n(this.series, function(c) {
                    g = { xAxis: f, xData: c.xData, chart: a, destroyGroupedData: ha };
    ...
    R(Pa.prototype, "pan", function(a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (l.ordinalPositions) {
                if (Q(f) > 1)
                    j && n(j, function(a) { a.setState() }), f < 0 ? (j = l, q = c.ordinalPositions ? c : l) : (j = c.ordinalPositions ? c : l, q = l), l = q.ordinalPositions, h >
                        l[l.length - 1] && l.push(h), this.fixedRange = k - i, f = c.toFixedRange(null, null, m.apply(j, [o.apply(j, [i, !0]) + f, !0]), m.apply(q, [o.apply(q, [k, !0]) + f, !0])), f.min >= B(g.dataMin, i) && f.max <= x(h, k) && c.setExtremes(f.min, f.max, !0, !1, { trigger: "pan" }), this.mouseDownX = d, M(this.container, { cursor: "move" });
            } else e = !0;
        } else e = !0;
    ...
    (function(a) {
        function b() { return Array.prototype.slice.call(arguments, 1) }
        ...
        e(g.prototype, {
            ...
            isInAnyBreak: function(a, b) {
                var d = this.options.breaks, e = d && d.length, f, g, h;
                if (e) {
            ...
            if (this.options.breaks) {
                ...
                this.setAxisTranslation = function(a) {
                    ...
                    for (p in b) {
                        ...
                        for (; n < j;)n += h;
                        for (; n < k; n += h)a.push({ value: n, move: "in" }), a.push({ value: n + (i.to - i.from), move: "out", size: i.breakSize });
                    }
                    a.sort(function(a, b) { return a.value === b.value ? (a.move === "in" ? 0 : 1) - (b.move === "in" ? 0 : 1) : a.value - b.value });
                    b = 0;
                    n = j;
                    for (p in a) {
                        i = a[p];
                        ...
                        b === 0 && (c.push({ from: n, to: i.value, len: i.value - n - (i.size || 0) }), e += i.value - n - (i.size || 0));
                    }
                    d.breakArray = c;
                    f(d, "afterBreaks");
        ...
        d(h.prototype, "generatePoints", function(a) {
            ...
            var c = this.xAxis, d = this.yAxis, e = this.points, f, g = e.length, h = this.options.connectNulls, n;
            if (c && d && (c.options.breaks || d.options.breaks))for (; g--;)if (f = e[g], n = f.y === null && h === !1, !n && (c.isInAnyBreak(f.x, !0) || d.isInAnyBreak(f.y, !0)))e.splice(g, 1), this.data[g] && this.data[g].destroyElements();
        });
        d(a.seriesTypes.column.prototype, "drawPoints", function(a) {
            ...
            for (g = 0; g < a.length; g++) {
                ...
                for (h = 0; h < c.length; h++)
                    ...
                    else n > e.to ? f(b, "pointBreak", { point: d, brk: e }) : f(b, "pointInBreak", { point: d, brk: e });
            }
        });
    })(A);
    var da = O.prototype,
        N = Lb.prototype,
        jc = da.processData,
        kc = da.generatePoints,
        lc = da.destroy,
        mc = N.tooltipFooterHeaderFormatter,
        nc = {
        ...
        Qa = {
            ...
            high: function(a) { return a.length ? Fa(a) : a.hasNulls ? null : r },
            low: function(a) { return a.length ? Sa(a) : a.hasNulls ? null : r },
    ...
    da.groupData = function(a,
        b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, k, j, m = !!b, l = [[], [], [], []], d = typeof d === "function" ? d : Qa[d], o = this.pointArrayMap, n = o && o.length, s;
        for (s = 0; s <= i; s++)if (a[s] >= c[0])break;
        for (; s <= i; s++) {
            for (; c[1] !== r && a[s] >= c[1] || s === i;)if (k = c.shift(), j = d.apply(0, l), j !== r && (g.push(k), h.push(j)), l[0] = [], l[1] = [], l[2] = [], l[3] = [], s === i)break;
            if (s === i)break;
            if (o) {
                k = this.cropStart + s;
                ...
                for (j = 0; j < n; j++)
                    if (p = k[o[j]],
                        typeof p === "number")l[j].push(p);
                    else if (p === null)l[j].hasNulls = !0;
            } else if (k = m ? b[s] : null, typeof k === "number")l[0].push(k);
    ...
    da.processData = function() {
        ...
        if (jc.apply(this, arguments) !== !1 && d) {
            ...
            if (k) {
                e = !0;
                this.points = null;
                var j = a.getExtremes(), d = j.min, j = j.max, i = i && a.getGroupIntervalFactor(d, j, this) || 1, h = k * (j - d) / h * i, k = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Yb), d, j, a.options.startOfWeek, f, this.closestPointRange), g = da.groupData.apply(this, [f, g, k, c.approximation]), f = g[0], g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
    ...
    da.destroyGroupedData = function() {
        ...
        n(a || [], function(b, c) { b && (a[c] = b.destroy ? b.destroy() : null) });
    ...
    N.tooltipFooterHeaderFormatter = function(a, b) {
        ...
        h && h.options.type === "datetime" && e && sa(a.key) ? (c = c.currentDataGrouping, e = e.dateTimeLabelFormats, c ? (h = e[c.unitName], c.count === 1 ? f = h[0] : (f = h[1], g = h[2])) : !f && e && (f = this.getXDateFormat(a, d, h)), f = ka(f, a.key), g && (f += ka(g, a.key + c.totalRange - 1)), d = d[(b ? "footer" : "header") + "Format"].replace("{point.key}", f)) : d = mc.call(this,
            a, b);
        return d;
    };
    da.destroy = function() {
    ...
    R(da, "setOptions", function(a, b) {
        var c = a.call(this, b), d = this.type, e = this.chart.options.plotOptions, f = U[d].dataGrouping;
    ...
    J.prototype.setDataGrouping = function(a, b) {
        ...
        this instanceof J ? n(this.series, function(b) {
            b.update({ dataGrouping: a },
                !1);
        }) : n(this.chart.options.series, function(b) { b.dataGrouping = a });
    };
    U.ohlc = z(U.column, { lineWidth: 1, tooltip: { pointFormat: "<span style=\"color:{point.color}\">\u25CF</span> <b> {series.name}</b><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>" }, states: { hover: { lineWidth: 3 } }, threshold: null });
    N = ja(G.column, {
        type: "ohlc",
        ...
        getAttribs: function() {
            ...
            n(this.points, function(a) { if (a.open < a.close && !a.options.color)a.pointAttr = c });
        },
        translate: function() {
            var a = this.yAxis;
        ...
        drawPoints: function() {
            ...
            n(a.points, function(j) {
                if (j.plotY !== r)
                    i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, k = v(j.plotX) - f, g = v(j.shapeArgs.width / 2), h = ["M", k, v(j.yBottom), "L", k, v(j.plotY)], j.open !== null && (d = v(j.plotOpen) + f, h.push("M", k, d, "L", k - g, d)), j.close !== null && (e = v(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)), i ? i.attr(c).animate({ d: h }) :
    ...
    G.ohlc = N;
    U.candlestick = z(U.column, { lineColor: "black", lineWidth: 1, states: { hover: { lineWidth: 2 } }, tooltip: U.ohlc.tooltip, threshold: null, upColor: "white" });
    N = ja(N, {
        type: "candlestick",
        pointAttrToOptions: { fill: "color", stroke: "lineColor", "stroke-width": "lineWidth" },
        upColorProp: "fill",
        getAttribs: function() {
            G.ohlc.prototype.getAttribs.apply(this, arguments);
            var a = this.options,
                b = a.states,
        ...
        drawPoints: function() {
            ...
            n(a.points, function(n) {
                l = n.graphic;
                if (n.plotY !== r)
                    c = n.pointAttr[n.selected ? "selected" : ""] || d, j = c["stroke-width"] % 2 / 2, m = v(n.plotX) - j, e = n.plotOpen, f = n.plotClose, g = X.min(e, f), h = X.max(e, f), q = v(n.shapeArgs.width /
                        2), i = v(g) !== v(n.plotY), k = h !== n.yBottom, g = v(g) + j, h = v(h) + j, o = ["M", m - q, h, "L", m - q, g, "L", m + q, g, "L", m + q, h, "Z", "M", m, g, "L", m, i ? v(n.plotY) : g, "M", m, h, "L", m, k ? v(n.yBottom) : h], l ? l.attr(c).animate({ d: o }) : n.graphic = b.renderer.path(o).attr(c).add(a.group).shadow(a.options.shadow);
            });
        }
    });
    G.candlestick = N;
    var ub = na.prototype.symbols;
    U.flags = z(U.column, {
        fillColor: "white",
        lineWidth: 1,
        pointRange: 0,
    ...
    G.flags = ja(G.column, {
            ...
            if (d && d.visible && h) {
                ...
                for (b.sort(function(a, b) { return a.x - b.x }); h-- && b[c];)
                    if (d = b[c], j = g[h], j.x <= d.x && j.plotY !== r) {
                        if (d.x <= m)d.plotY = j.plotY, j.x < d.x && !f && (l = g[h + 1]) && l.plotY !== r && (d.plotY += (d.x - j.x) / (l.x - j.x) * (l.plotY - j.plotY));
                        c--;
                        h++;
                        if (c < 0)break;
                    }
        ...
        drawPoints: function() {
            ...
            for (k = c.length; k--;)
                if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX - p(j.lineWidth, g.lineWidth) % 2, m = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== r && (f = j.plotY + h - (m !== r && m * g.stackDistance)), l = m ? r : j.plotX, o = m ? r : j.plotY, m = j.graphic, f !== r && e >= 0 && !a)
                    a = j.pointAttr[j.selected ?
                        "select" : ""] || b, m ? m.attr({ x: e, y: f, r: a.r, anchorX: l, anchorY: o }) : j.graphic = d.label(j.options.title || g.title || "A", e, f, i, l, o, g.useHTML).css(z(g.style, j.style)).attr(a).attr({ align: i === "flag" ? "left" : "center", width: g.width, height: g.height }).add(this.markerGroup).shadow(g.shadow), j.tooltipPos = [e, f];
            ...
            n(a, function(b) {
                ...
                c && D(c.element, "mouseover", function() {
                    if (b.stackIndex > 0 && !b.raised)
                        b._y =
                            c.y, c.attr({ y: b._y - 8 }), b.raised = !0;
                    n(a, function(a) { if (a !== b && a.raised && a.graphic)a.graphic.attr({ y: a._y }), a.raised = !1 });
                });
            });
        },
        animate: ha,
    ...
    ub.flag = function(a, b, c, d, e) { return["M", e && e.anchorX || a, e && e.anchorY || b, "L", a, b + d, a, b, a + c, b, a + c, b + d, a, b + d, "Z"] };
    n(["circle", "square"], function(a) {
        ub[a + "pin"] = function(b, c, d, e, f) {
            var g = f && f.anchorX, f = f && f.anchorY;
            a === "circle" && e > d && (b -= v((e - d) / 2), d = e);
            b = ub[a](b, c, d, e);
    ...
    Wa === A.VMLRenderer &&
        n(["flag", "circlepin", "squarepin"], function(a) { ib.prototype.symbols[a] = ub[a] });
    var N = [].concat(Yb),
        vb = function(a) {
            var b = hb(arguments, function(a) { return typeof a === "number" });
    ...
    w(P, {
        navigator: {
            ...
            outlineWidth: 1,
            series: {
                type: G.areaspline === r ? "line" : "areaspline",
                color: "#4572A7",
                compare: null,
                fillOpacity: 0.05,
        ...
        scrollbar: { height: fb ? 20 : 14, barBackgroundColor: "#bfc8d1", barBorderRadius: 0, barBorderWidth: 1, barBorderColor: "#bfc8d1", buttonArrowColor: "#666", buttonBackgroundColor: "#ebe7e8", buttonBorderColor: "#bbb", buttonBorderRadius: 0, buttonBorderWidth: 1, minWidth: 6, rifleColor: "#666", trackBackgroundColor: "#eeeeee", trackBorderColor: "#eeeeee", trackBorderWidth: 1, liveRedraw: ea && !fb }
    });
    Gb.prototype = {
        ...
        render: function(a, b, c, d) {
            ...
            if (u(a) && !isNaN(a)) {
                ...
                if (!(m.translate(d, !0) - m.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    a = c - b;
                    if (!this.rendered) {
                        if (A)this.navigatorGroup = m = f.g("navigator").attr({ zIndex: 3 }).add(), this.leftShade = f.rect().attr({ fill: r.maskFill }).add(m), r.maskInside ? this.leftShade.css({ cursor: "ew-resize" }) : this.rightShade = f.rect().attr({ fill: r.maskFill }).add(m), this.outline = f.path().attr({ "stroke-width": D, stroke: r.outlineColor }).add(m);
                        if (s)
                            this.scrollbarGroup = j = f.g("scrollbar").add(), l = w.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                                x: 0,
                                y: -l % 2 / 2,
                                ...
                                height: n
                            }).add(j), this.scrollbar = l = f.rect().attr({ y: -H % 2 / 2, height: n, fill: w.barBackgroundColor, stroke: w.barBorderColor, "stroke-width": H, r: I }).add(j), this.scrollbarRifles = f.path().attr({ stroke: w.rifleColor, "stroke-width": 1 }).add(j);
                    }
                    e = e.isResizing ? "animate" : "attr";
                    if (A) {
                        this.leftShade[e](r.maskInside ? { x: g + b, y: z, width: c - b, height: y } : { x: g, y: z, width: b, height: y });
                        if (this.rightShade)
                            this.rightShade[e]({
                                x: g +
                                    c,
                        ...
                        this.outline[e]({ d: ["M", i, F, "L", g + b - C, F, g + b - C, F + K, "L", g + c - C, F + K, "L", g + c - C, F, i + k, F].concat(r.maskInside ? ["M", g + b + C, F, "L", g + c - C, F] : []) });
                        this.drawHandle(b + C, 0);
                        this.drawHandle(c + C, 1);
                    }
                    if (s && j)
                        this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({ translateX: i, translateY: v(F + y) }), o[e]({ width: k }), g = n + b, h = a - H, h < t && (G = (t - h) / 2, h = t, g -= G), this.scrollbarPad = G, l[e]({ x: W(g) + H % 2 / 2, width: h }), t = n + b + a / 2 - 0.5, this.scrollbarRifles.attr({ visibility: a > 12 ? "visible" : "hidden" })[e]({
                            d: [
                                "M",
                                t - 3, n / 4, "L", t - 3, 2 * n / 3, "M", t, n / 4, "L", t, 2 * n / 3, "M", t + 3, n / 4, "L", t + 3, 2 * n / 3
                            ]
                        });
                    this.scrollbarPad = G;
                    this.rendered = !0;
        ...
        addEvents: function() {
            ...
            n(e, function(a) { D.apply(null, a) });
            this._events = e;
        },
        removeEvents: function() {
            n(this._events, function(a) { T.apply(null, a) });
            this._events =
                r;
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollbarHeight, k = a.scrollerLeft, l = a.scrollerWidth, m = a.navigatorLeft, n = a.navigatorWidth, p = a.scrollbarPad, r = a.range, u = d.chartX, v = d.chartY, d = b.xAxis[0], x, w = fb ? 10 : 7;
                if (v > h && v < h + g + j)
                    if ((h =
                        !a.scrollbarEnabled || v < h + g) && X.abs(u - e - m) < w)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    else if (h && X.abs(u - f - m) < w)a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null;
                    else if (u > m + e - p && u < m + f + p)a.grabbedCenter = u, a.fixedWidth = r, i = u - e;
                    else if (u > k && u < k + l) {
                        f = h ? u - m - r / 2 : u < m ? e - r * 0.2 : u > k + l - j ? e + r * 0.2 : u < m + e ? e - r : f;
                        if (f < 0)f = 0;
                        else if (f + r >= n)f = n - r, x = a.getUnionExtremes().dataMax;
                        if (f !== e)
                            a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, x), d.setExtremes(e.min, e.max,
            ...
            a.navigatorEnabled ? (a.xAxis = c = new J(b, z({ breaks: j && j.xAxis.options.breaks, ordinal: j && j.xAxis.options.ordinal }, f.xAxis, { id: "navigator-x-axis", isX: !0, type: "datetime", index: m, height: g, offset: 0, offsetLeft: e, offsetRight: -e, keepOrdinalPadding: !0, startOnTick: !1, endOnTick: !1, minPadding: 0, maxPadding: 0, zoomEnabled: !1 })), a.yAxis = d = new J(b, z(f.yAxis, { id: "navigator-y-axis", alignTicks: !1, height: g, offset: 0, index: l, zoomEnabled: !1 })), j || f.series.data ? a.addBaseSeries() : b.series.length === 0 && R(b, "redraw", function(c,
                ...
                translate: function(a, c) {
                    var d = b.xAxis[0], f = d.getExtremes(), g = b.plotWidth - 2 * e, h = vb("min", d.options.min, f.dataMin), d = vb("max", d.options.max, f.dataMax) - h;
        ...
        getUnionExtremes: function(a) {
            ...
            if (!a || b.dataMin !== null)f = { dataMin: p(d && d.min, vb("min", e.min, b.dataMin, c.dataMin)), dataMax: p(d && d.max, vb("max", e.max, b.dataMax, c.dataMax)) };
            return f;
        },
        ...
        addBaseSeries: function() {
            ...
            b = z(b, d, { enableMouseTracking: !1, group: "nav", padXAxis: !1, xAxis: "navigator-x-axis", yAxis: "navigator-y-axis", name: "Navigator", showInLegend: !1, isInternal: !0, visible: !0 });
            b.data = e || c;
            this.series = this.chart.initSeries(b);
            if (a && this.navigatorOptions.adaptToUpdatedData !==
                !1)D(a, "updatedData", this.updatedDataHandler), a.userOptions.events = w(a.userOptions.event, { updatedData: this.updatedDataHandler });
        },
        updatedDataHandler: function() {
            ...
            k && (j = d, i || (m = x(j -
                h, n.xData[0])));
            p && (i || k) ? isNaN(m) || c.setExtremes(m, j, !0, !1, { trigger: "updatedData" }) : (l && this.chart.redraw(!1), a.render(x(e, g), B(f, d)));
        },
        destroy: function() {
            this.removeEvents();
            n([this.xAxis, this.yAxis, this.leftShade, this.rightShade, this.outline, this.scrollbarTrack, this.scrollbarRifles, this.scrollbarGroup, this.scrollbar], function(a) { a && a.destroy && a.destroy() });
            this.xAxis = this.yAxis = this.leftShade = this.rightShade = this.outline = this.scrollbarTrack = this.scrollbarRifles = this.scrollbarGroup = this.scrollbar =
                null;
            n([this.scrollbarButtons, this.handles, this.elementsToDestroy], function(a) { Na(a) });
        }
    };
    A.Scroller = Gb;
    ...
    Hb.prototype = {
        clickButton: function(a, b) {
            ...
            if (!(k === null || j === null || a === c.selected)) {
                if (z)this.forcedDataGrouping = !0, J.prototype.setDataGrouping.call(h || { chart: this.chart }, z, !1);
                if (q === "month" || q === "year")m = { month: "Month", year: "FullYear" }[q], o["set" + m](o["get" + m]() - s), m = o.getTime(), k = p(k, Number.MIN_VALUE), isNaN(m) || m < k ? (m = k, l = B(m + i, j)) : i = l - m;
                else if (i)m = x(l - i, k), l = B(m + i, j);
                else if (q === "ytd")
                    if (h) {
                        if (j === r)
                ...
                else q === "all" && h && (m = k, l = j);
                f[d] && f[d].setState(0);
                f[a] && f[a].setState(2);
                e.fixedRange = i;
                h ? (h.setExtremes(m, l, p(b, 1), 0, { trigger: "rangeSelectorButton", rangeSelectorButton: g }), c.setSelected(a)) : (u = e.options.xAxis[0], y = u.range, u.range = i, t = u.min, u.min = w, c.setSelected(a), D(e, "load", function() {
                    u.range = y;
                    u.min = t;
                }));
            }
        ...
        init: function(a) {
            ...
            D(a, "load", function() {
                D(a.xAxis[0], "setExtremes", function(c) { this.max - this.min !== a.fixedRange && c.trigger !== "rangeSelectorButton" && c.trigger !== "updatedData" && b.forcedDataGrouping && this.setDataGrouping(!1, !1) });
                D(a.xAxis[0], "afterSetExtremes", function() { b.updateButtonStates(!0) });
            });
        },
        updateButtonStates: function(a) {
            var b = this,
                c = this.chart,
                d = c.xAxis[0],
                e = c.scroller && c.scroller.getUnionExtremes() ||
                    d,
                f = e.dataMin,
                g = e.dataMax,
                h = b.selected,
                ...
                k = b.buttons;
            a && c.fixedRange !== v(d.max - d.min) && (k[h] && k[h].setState(0), b.setSelected(null));
            n(b.buttonOptions, function(a, c) {
                var e = a._range, n = e > g - f, p = e < d.minRange, s = a.type === "all" && d.max - d.min >= g - f && k[c].state !== 2, r = a.type === "ytd" && ka("%Y", f) === ka("%Y", g);
                e === v(d.max - d.min) && c !== h ? (b.setSelected(c), k[c].setState(2)) : !i && (n || p || s || r) ? k[c].setState(3) : k[c].state === 3 && k[c].setState(0);
            });
        },
        ...
        setInputValue: function(a, b) {
            ...
            this[a + "DateBox"].attr({ text: ka(c.inputDateFormat || "%b %e, %Y", this[a + "Input"].HCTime) });
        },
        showInput: function(a) {
            var b = this.inputGroup,
                c = this[a +
                    "DateBox"];
            M(this[a + "Input"], { left: b.translateX + c.x + "px", top: b.translateY + "px", width: c.width - 2 + "px", height: c.height - 2 + "px", border: "2px solid silver" });
        },
        hideInput: function(a) { document.activeElement === this[a + "Input"] && (M(this[a + "Input"], { border: 0, width: "1px", height: "1px" }), this.setInputValue(a)) },
        drawInput: function(a) {
            var b = this, c = b.chart, d = c.renderer.style, e = c.renderer, f = c.options.rangeSelector, g = b.div, h = a === "min", i, k, j = this.inputGroup;
            this[a + "Label"] = k = e.label(P.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"],
                this.inputGroup.offset).attr({ padding: 2 }).css(z(d, f.labelStyle)).add(j);
            j.offset += k.width + 5;
            this[a + "DateBox"] = e = e.label("", j.offset).attr({ padding: 2, width: f.inputBoxWidth || 90, height: f.inputBoxHeight || 17, stroke: f.inputBoxBorderColor || "silver", "stroke-width": 1 }).css(z({ textAlign: "center", color: "#444" }, d, f.inputStyle)).on("click", function() {
                b.showInput(a);
                b[a + "Input"].focus();
            }).add(j);
            j.offset += e.width + (h ? 10 : 0);
            this[a + "Input"] = i = aa("input", { name: a, className: "highcharts-range-selector", type: "text" }, w({
                position: "absolute",
                border: 0,
                width: "1px",
                height: "1px",
            ...
            i.onfocus = function() { b.showInput(a) };
            i.onblur = function() { b.hideInput(a) };
            i.onchange = function() {
                var a = i.value, d = (f.inputDateParser || fa.parse)(a), e = c.xAxis[0], g = e.dataMin, j = e.dataMax;
                isNaN(d) && (d = a.split("-"), d = fa.UTC(L(d[0]), L(d[1]) - 1, L(d[2])));
                isNaN(d) || (P.global.useUTC || (d += (new fa).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = r : d < g && (d = g) : d < b.minInput.HCTime ?
                    d = r : d > j && (d = j), d !== r && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, r, r, { trigger: "rangeSelectorInput" }));
            };
        },
        getPosition: function() {
            var a = this.chart, a = p((a.options.rangeSelector.buttonPosition || {}).y, a.plotTop - a.axisOffset[0] - 35);
        ...
        render: function(a, b) {
            var c = this,
                ...
                v = this.getPosition(),
                t = c.group;
            if (!c.rendered && (c.group = t = e.g("range-selector-buttons").add(), c.zoomText = e.text(g.rangeSelectorZoom, p(l.x, s), v.buttonTop + 15).css(i.labelStyle).add(t), r = p(l.x, s) + c.zoomText.getBBox().width + 5, n(c.buttonOptions, function(a, b) {
                    k[b] = e.button(a.text, r, v.buttonTop, function() {
                        c.clickButton(b);
                        c.isActive = !0;
                    }, m, q && q.hover, q && q.select, q && q.disabled).css({ textAlign: "center" }).add(t);
                    r += k[b].width + p(i.buttonSpacing, 5);
                    c.selected === b && k[b].setState(2);
                }),
                c.updateButtonStates(), o !== !1))c.div = j = aa("div", null, { position: "relative", height: 0, zIndex: 1 }), f.parentNode.insertBefore(j, f), c.inputGroup = j = e.g("input-group").add(), j.offset = 0, c.drawInput("min"), c.drawInput("max");
            o !== !1 && (j.align(w({ y: v.inputTop, width: j.offset, x: h && v.inputTop < (h.y || 0) + h.height - d.spacing[0] ? -40 : 0 }, i.inputPosition), !0, d.spacingBox), u(o) || (d = t.getBBox(), j[j.translateX < d.x + d.width + 10 ? "hide" : "show"]()), c.setInputValue("min", a), c.setInputValue("max", b));
            c.rendered = !0;
        },
        destroy: function() {
            var a =
    ...
    J.prototype.toFixedRange = function(a, b, c, d) {
        ...
        c > 0.7 && c < 1.3 && (d ? a = b - e : b = a +
            e);
        return{ min: a, max: b };
    };
    R(Pa.prototype, "init", function(a, b, c) {
        D(this, "init", function() { if (this.options.rangeSelector.enabled)this.rangeSelector = new Hb(this) });
        a.call(this, b, c);
    });
    A.RangeSelector = Hb;
    ...
    A.StockChart = function(a, b) {
        var c = a.series, d, e = p(a.navigator && a.navigator.enabled, !0) ? { startOnTick: !1, endOnTick: !1 } : null, f = { marker: { enabled: !1, radius: 2 } }, g = { shadow: !1, borderWidth: 0 };
        a.xAxis = Aa(pa(a.xAxis ||
        {}), function(a) { return z({ minPadding: 0, maxPadding: 0, ordinal: !0, title: { text: null }, labels: { overflow: "justify" }, showLastLabel: !0 }, a, { type: "datetime", categories: null }, e) });
        a.yAxis = Aa(pa(a.yAxis || {}), function(a) {
            d = p(a.opposite, !0);
            return z({ labels: { y: -2 }, opposite: d, showLastLabel: !1, title: { text: null } }, a);
        });
        a.series = null;
        a = z({
    ...
    R(J.prototype, "getPlotLinePath", function(a, b, c, d, e, f) {
        var g = this, h = this.isLinked && !this.series ? this.linkedParent.series : this.series, i = g.chart, k = i.renderer, j = g.left, m = g.top, l, o, q, s, r = [], w = [], t;
        if (g.coll === "colorAxis")
            return a.apply(this,
            [].slice.call(arguments, 1));
        w = g.isXAxis ? u(g.options.yAxis) ? [i.yAxis[g.options.yAxis]] : Aa(h, function(a) { return a.yAxis }) : u(g.options.xAxis) ? [i.xAxis[g.options.xAxis]] : Aa(h, function(a) { return a.xAxis });
        ...
        n(w, function(a) { Oa(a, t) === -1 && t.push(a) });
        f = p(f, g.translate(b,
            null, null, d));
        isNaN(f) || (g.horiz ? n(t, function(a) {
            ...
            s = o + a.len;
            l = q = v(f + g.transB);
            if (l < j || l > j + g.width)e ? l = q = B(x(j, l), j + g.width) : b = !0;
            b || r.push("M", l, o, "L", q, s);
        }) : n(t, function(a) {
            var b;
            l = a.pos;
            q = l + a.len;
            o = s = v(m + g.height - f);
            if (o < m || o > m + g.height)e ? o = s = B(x(m, o), g.top + g.height) : b = !0;
            b || r.push("M", l, o, "L", q, s);
        }));
        return r.length > 0 ? k.crispPolyLine(r, c || 1) : null;
    });
    J.prototype.getPlotBandPath = function(a, b) {
        ...
        if (d &&
            c && d.toString() !== c.toString())for (f = 0; f < d.length; f += 6)e.push("M", d[f + 1], d[f + 2], "L", d[f + 4], d[f + 5], c[f + 4], c[f + 5], c[f + 1], c[f + 2]);
        else e = null;
        return e;
    };
    na.prototype.crispPolyLine = function(a, b) {
        var c;
        for (c = 0; c < a.length; c += 6)a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = v(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = v(a[c + 2]) + b % 2 / 2);
        return a;
    };
    if (Wa === A.VMLRenderer)ib.prototype.crispPolyLine = na.prototype.crispPolyLine;
    R(J.prototype, "hideCrosshair", function(a, b) {
        a.call(this, b);
        u(this.crossLabelArray) && (u(b) ? this.crossLabelArray[b] &&
            this.crossLabelArray[b].hide() : n(this.crossLabelArray, function(a) { a.hide() }));
    });
    R(J.prototype, "drawCrosshair", function(a, b, c) {
        var d, e;
        a.call(this, b, c);
        if (u(this.crosshair.label) && this.crosshair.label.enabled && u(c)) {
            var a = this.chart, f = this.options.crosshair.label, g = this.isXAxis ? "x" : "y", b = this.horiz, h = this.opposite, i = this.left, k = this.top, j = this.crossLabel, m, l, n = f.format, q = "";
            if (!j)
            ...
            if (l < k || l > k + this.height)this.hideCrosshair();
                ...
                j.attr({
                    text: n ?
                        Ma(n, { value: c[g] }) : f.formatter.call(this, c[g]),
                    x: m,
                    y: l,
                    visibility: "visible"
                });
    ...
    var oc = da.init,
        pc = da.processData,
        qc = Ca.prototype.tooltipFormatter;
    da.init = function() {
    ...
    J.prototype.setCompare = function(a, b) { this.isXAxis || (n(this.series, function(b) { b.setCompare(a) }), p(b, !0) && this.chart.redraw()) };
    Ca.prototype.tooltipFormatter = function(a) {
        a = a.replace("{point.change}", (this.change > 0 ? "+" : "") + A.numberFormat(this.change,
            p(this.series.tooltipOptions.changeDecimals, 2)));
        return qc.apply(this, [a]);
    };
    R(O.prototype, "render", function(a) {
        if (this.chart.options._stock)!this.clipBox && this.animate ? (this.clipBox = z(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (ab(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({ width: this.xAxis.len, height: this.yAxis.len }));
        a.call(this);
    });
    w(A, {
        Color: wa,
